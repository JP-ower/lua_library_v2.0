...
---函数名：Equals
---@param p1 UnityEngine.Video.VideoRenderMode
...
CameraFarPlane = function() end,

---函数名：CameraNearPlane
---返回值：VideoRenderMode
---@return VideoRenderMode
CameraNearPlane = function() end,
...
---函数名：MaterialOverride
---返回值：VideoRenderMode
---@return VideoRenderMode
MaterialOverride = function() end,

---函数名：APIOnly
---返回值：VideoRenderMode
---@return VideoRenderMode
APIOnly = function() end,
