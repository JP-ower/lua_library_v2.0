...
---函数名：get_handleRect
---@param p1 UnityEngine.UI.Scrollbar
...
---函数名：get_direction
---@param p1 UnityEngine.UI.Scrollbar
---返回值：UnityEngine.UI.Scrollbar.Direction
...
---函数名：get_numberOfSteps
---@param p1 UnityEngine.UI.Scrollbar
---返回值：System.Int32
---@return System.Int32
numberOfSteps = function(p1) end,

---函数名：set_numberOfSteps
---@param p1 UnityEngine.UI.Scrollbar
numberOfSteps = function(p1) end,

---函数名：get_onValueChanged
---@param p1 UnityEngine.UI.Scrollbar
---返回值：UnityEngine.UI.Scrollbar.ScrollEvent
...
---函数名：SetDirection
---@param p1 UnityEngine.UI.Scrollbar
---@param p2 UnityEngine.UI.Scrollbar.Direction
