...
---函数名：Reset
---@param p1 UnityEngine.EdgeCollider2D
...
---函数名：GetPoints
---@param p1 UnityEngine.EdgeCollider2D
---@param p2 System.Collections.Generic.List`1[[UnityEngine.Vector2, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]
---返回值：System.Int32
---@return System.Int32
GetPoints = function(p1,p2) end,
...
SetPoints = function(p1,p2) end,

---函数名：get_useAdjacentStartPoint
---@param p1 UnityEngine.EdgeCollider2D
---返回值：System.Boolean
---@return System.Boolean
useAdjacentStartPoint = function(p1) end,

---函数名：set_useAdjacentStartPoint
---@param p1 UnityEngine.EdgeCollider2D
useAdjacentStartPoint = function(p1) end,

---函数名：get_useAdjacentEndPoint
---@param p1 UnityEngine.EdgeCollider2D
---返回值：System.Boolean
---@return System.Boolean
useAdjacentEndPoint = function(p1) end,

---函数名：set_useAdjacentEndPoint
---@param p1 UnityEngine.EdgeCollider2D
useAdjacentEndPoint = function(p1) end,

---函数名：get_adjacentStartPoint
---@param p1 UnityEngine.EdgeCollider2D
---返回值：UnityEngine.Vector2
---@return UnityEngine.Vector2
adjacentStartPoint = function(p1) end,

---函数名：set_adjacentStartPoint
---@param p1 UnityEngine.EdgeCollider2D
adjacentStartPoint = function(p1) end,

---函数名：get_adjacentEndPoint
---@param p1 UnityEngine.EdgeCollider2D
---返回值：UnityEngine.Vector2
---@return UnityEngine.Vector2
adjacentEndPoint = function(p1) end,

---函数名：set_adjacentEndPoint
---@param p1 UnityEngine.EdgeCollider2D
adjacentEndPoint = function(p1) end,
