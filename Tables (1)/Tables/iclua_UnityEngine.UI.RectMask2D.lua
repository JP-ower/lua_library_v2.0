...
---函数名：get_padding
---@param p1 UnityEngine.UI.RectMask2D
...
---函数名：get_softness
---@param p1 UnityEngine.UI.RectMask2D
---返回值：UnityEngine.Vector2Int
---@return UnityEngine.Vector2Int
softness = function(p1) end,
...
---函数名：IsRaycastLocationValid
---@param p1 UnityEngine.UI.RectMask2D
---@param p2 UnityEngine.Vector2
---@param p3 UnityEngine.Camera
---返回值：System.Boolean
---@return System.Boolean
IsRaycastLocationValid = function(p1,p2,p3) end,

---函数名：PerformClipping
---@param p1 UnityEngine.UI.RectMask2D
PerformClipping = function(p1) end,

---函数名：UpdateClipSoftness
---@param p1 UnityEngine.UI.RectMask2D
UpdateClipSoftness = function(p1) end,

---函数名：AddClippable
---@param p1 UnityEngine.UI.RectMask2D
---@param p2 UnityEngine.UI.IClippable
AddClippable = function(p1,p2) end,

---函数名：RemoveClippable
---@param p1 UnityEngine.UI.RectMask2D
---@param p2 UnityEngine.UI.IClippable
RemoveClippable = function(p1,p2) end,
