...
---函数名：Equals
---@param p1 UnityEngine.ParticleSystemRingBufferMode
...
---函数名：PauseUntilReplaced
---返回值：ParticleSystemRingBufferMode
---@return ParticleSystemRingBufferMode
PauseUntilReplaced = function() end,

---函数名：LoopUntilReplaced
---返回值：ParticleSystemRingBufferMode
---@return ParticleSystemRingBufferMode
LoopUntilReplaced = function() end,
