...
---函数名：get_maximumTileChangeCount
---@param p1 UnityEngine.Tilemaps.TilemapCollider2D
---返回值：System.UInt32
---@return System.UInt32
maximumTileChangeCount = function(p1) end,

---函数名：set_maximumTileChangeCount
---@param p1 UnityEngine.Tilemaps.TilemapCollider2D
maximumTileChangeCount = function(p1) end,

---函数名：get_extrusionFactor
---@param p1 UnityEngine.Tilemaps.TilemapCollider2D
---返回值：System.Single
---@return System.Single
extrusionFactor = function(p1) end,

---函数名：set_extrusionFactor
---@param p1 UnityEngine.Tilemaps.TilemapCollider2D
extrusionFactor = function(p1) end,

---函数名：get_hasTilemapChanges
---@param p1 UnityEngine.Tilemaps.TilemapCollider2D
---返回值：System.Boolean
---@return System.Boolean
hasTilemapChanges = function(p1) end,

---函数名：ProcessTilemapChanges
---@param p1 UnityEngine.Tilemaps.TilemapCollider2D
ProcessTilemapChanges = function(p1) end,
