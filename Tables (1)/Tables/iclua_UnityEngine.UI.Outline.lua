...
---函数名：ModifyMesh
---@param p1 UnityEngine.UI.Outline
---@param p2 UnityEngine.UI.VertexHelper
ModifyMesh = function(p1,p2) end,

---函数名：get_effectColor
---@param p1 UnityEngine.UI.Outline
---返回值：Color
---@return Color
effectColor = function(p1) end,

---函数名：set_effectColor
---@param p1 UnityEngine.UI.Outline
effectColor = function(p1) end,

---函数名：get_effectDistance
---@param p1 UnityEngine.UI.Outline
---返回值：Vector2
---@return Vector2
effectDistance = function(p1) end,

---函数名：set_effectDistance
---@param p1 UnityEngine.UI.Outline
effectDistance = function(p1) end,

---函数名：get_useGraphicAlpha
---@param p1 UnityEngine.UI.Outline
---返回值：Boolean
---@return Boolean
useGraphicAlpha = function(p1) end,

---函数名：set_useGraphicAlpha
---@param p1 UnityEngine.UI.Outline
useGraphicAlpha = function(p1) end,
