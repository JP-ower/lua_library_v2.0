...
---@param p1 UnityEngine.PointEffector2D
---返回值：Single
---@return Single
...
---函数名：get_distanceScale
---@param p1 UnityEngine.PointEffector2D
---返回值：Single
---@return Single
distanceScale = function(p1) end,

---函数名：set_distanceScale
---@param p1 UnityEngine.PointEffector2D
distanceScale = function(p1) end,
...
---函数名：get_forceMode
---@param p1 UnityEngine.PointEffector2D
---返回值：EffectorForceMode2D
---@return EffectorForceMode2D
forceMode = function(p1) end,
