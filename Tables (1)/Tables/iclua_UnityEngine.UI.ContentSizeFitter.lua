...
---函数名：get_horizontalFit
---@param p1 UnityEngine.UI.ContentSizeFitter
---返回值：UnityEngine.UI.ContentSizeFitter.FitMode
---@return UnityEngine.UI.ContentSizeFitter.FitMode
horizontalFit = function(p1) end,

---函数名：set_horizontalFit
---@param p1 UnityEngine.UI.ContentSizeFitter
horizontalFit = function(p1) end,
