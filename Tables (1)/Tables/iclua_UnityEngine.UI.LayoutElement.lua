...
---函数名：get_ignoreLayout
---@param p1 UnityEngine.UI.LayoutElement
---返回值：System.Boolean
---@return System.Boolean
ignoreLayout = function(p1) end,

---函数名：set_ignoreLayout
---@param p1 UnityEngine.UI.LayoutElement
ignoreLayout = function(p1) end,
