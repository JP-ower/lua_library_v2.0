...
---函数名：get_startCorner
---@param p1 UnityEngine.UI.GridLayoutGroup
---返回值：UnityEngine.UI.GridLayoutGroup.Corner
---@return UnityEngine.UI.GridLayoutGroup.Corner
startCorner = function(p1) end,
...
---函数名：get_startAxis
---@param p1 UnityEngine.UI.GridLayoutGroup
---返回值：UnityEngine.UI.GridLayoutGroup.Axis
---@return UnityEngine.UI.GridLayoutGroup.Axis
startAxis = function(p1) end,
...
---函数名：get_constraint
---@param p1 UnityEngine.UI.GridLayoutGroup
---返回值：UnityEngine.UI.GridLayoutGroup.Constraint
---@return UnityEngine.UI.GridLayoutGroup.Constraint
constraint = function(p1) end,

---函数名：set_constraint
---@param p1 UnityEngine.UI.GridLayoutGroup
constraint = function(p1) end,

---函数名：get_constraintCount
---@param p1 UnityEngine.UI.GridLayoutGroup
---返回值：System.Int32
---@return System.Int32
constraintCount = function(p1) end,

---函数名：set_constraintCount
---@param p1 UnityEngine.UI.GridLayoutGroup
constraintCount = function(p1) end,
