...
---函数名：Equals
---@param p1 UnityEngine.ParticleSystemStopBehavior
...
---函数名：StopEmittingAndClear
---返回值：ParticleSystemStopBehavior
---@return ParticleSystemStopBehavior
StopEmittingAndClear = function() end,

---函数名：StopEmitting
---返回值：ParticleSystemStopBehavior
---@return ParticleSystemStopBehavior
StopEmitting = function() end,
