...
---函数名：get_sortOrderPriority
---@param p1 UnityEngine.UI.GraphicRaycaster
---返回值：System.Int32
---@return System.Int32
sortOrderPriority = function(p1) end,

---函数名：get_renderOrderPriority
---@param p1 UnityEngine.UI.GraphicRaycaster
---返回值：System.Int32
---@return System.Int32
renderOrderPriority = function(p1) end,

---函数名：get_ignoreReversedGraphics
---@param p1 UnityEngine.UI.GraphicRaycaster
---返回值：System.Boolean
---@return System.Boolean
ignoreReversedGraphics = function(p1) end,

---函数名：set_ignoreReversedGraphics
---@param p1 UnityEngine.UI.GraphicRaycaster
ignoreReversedGraphics = function(p1) end,

---函数名：get_blockingObjects
---@param p1 UnityEngine.UI.GraphicRaycaster
---返回值：UnityEngine.UI.GraphicRaycaster.BlockingObjects
---@return UnityEngine.UI.GraphicRaycaster.BlockingObjects
blockingObjects = function(p1) end,

---函数名：set_blockingObjects
---@param p1 UnityEngine.UI.GraphicRaycaster
blockingObjects = function(p1) end,

---函数名：get_blockingMask
---@param p1 UnityEngine.UI.GraphicRaycaster
---返回值：UnityEngine.LayerMask
---@return UnityEngine.LayerMask
blockingMask = function(p1) end,

---函数名：set_blockingMask
---@param p1 UnityEngine.UI.GraphicRaycaster
blockingMask = function(p1) end,
...
eventCamera = function(p1) end,

---函数名：get_priority
---@param p1 UnityEngine.UI.GraphicRaycaster
---返回值：System.Int32
---@return System.Int32
priority = function(p1) end,

---函数名：get_rootRaycaster
---@param p1 UnityEngine.UI.GraphicRaycaster
---返回值：UnityEngine.EventSystems.BaseRaycaster
---@return UnityEngine.EventSystems.BaseRaycaster
rootRaycaster = function(p1) end,
