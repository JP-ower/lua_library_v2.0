...
---函数名：get_force
---@param p1 UnityEngine.ConstantForce2D
---返回值：UnityEngine.Vector2
---@return UnityEngine.Vector2
force = function(p1) end,

---函数名：set_force
---@param p1 UnityEngine.ConstantForce2D
force = function(p1) end,

---函数名：get_relativeForce
---@param p1 UnityEngine.ConstantForce2D
---返回值：UnityEngine.Vector2
---@return UnityEngine.Vector2
relativeForce = function(p1) end,

---函数名：set_relativeForce
---@param p1 UnityEngine.ConstantForce2D
relativeForce = function(p1) end,
