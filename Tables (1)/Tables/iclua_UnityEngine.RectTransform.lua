...
---函数名：add_reapplyDrivenProperties
add_reapplyDrivenProperties = function() end,

---函数名：remove_reapplyDrivenProperties
remove_reapplyDrivenProperties = function() end,

---函数名：get_rect
---@param p1 UnityEngine.RectTransform
...
---返回值：UnityEngine.Vector2
---@return UnityEngine.Vector2
anchorMax = function(p1) end,

---函数名：set_anchorMax
---@param p1 UnityEngine.RectTransform
anchorMax = function(p1) end,

---函数名：get_anchoredPosition
---@param p1 UnityEngine.RectTransform
---返回值：UnityEngine.Vector2
---@return UnityEngine.Vector2
anchoredPosition = function(p1) end,

---函数名：set_anchoredPosition
---@param p1 UnityEngine.RectTransform
anchoredPosition = function(p1) end,
...
---函数名：get_anchoredPosition3D
---@param p1 UnityEngine.RectTransform
---返回值：UnityEngine.Vector3
---@return UnityEngine.Vector3
anchoredPosition3D = function(p1) end,

---函数名：set_anchoredPosition3D
---@param p1 UnityEngine.RectTransform
anchoredPosition3D = function(p1) end,
...
---返回值：UnityEngine.Vector2
---@return UnityEngine.Vector2
offsetMax = function(p1) end,

---函数名：set_offsetMax
---@param p1 UnityEngine.RectTransform
offsetMax = function(p1) end,

---函数名：ForceUpdateRectTransforms
---@param p1 UnityEngine.RectTransform
ForceUpdateRectTransforms = function(p1) end,

---函数名：GetLocalCorners
---@param p1 UnityEngine.RectTransform
---@param p2 UnityEngine.Vector3[]
GetLocalCorners = function(p1,p2) end,

---函数名：GetWorldCorners
---@param p1 UnityEngine.RectTransform
---@param p2 UnityEngine.Vector3[]
GetWorldCorners = function(p1,p2) end,

---函数名：SetInsetAndSizeFromParentEdge
---@param p1 UnityEngine.RectTransform
---@param p2 UnityEngine.RectTransform.Edge
---@param p3 System.Single
---@param p4 System.Single
SetInsetAndSizeFromParentEdge = function(p1,p2,p3,p4) end,

---函数名：SetSizeWithCurrentAnchors
---@param p1 UnityEngine.RectTransform
---@param p2 UnityEngine.RectTransform.Axis
---@param p3 System.Single
SetSizeWithCurrentAnchors = function(p1,p2,p3) end,
