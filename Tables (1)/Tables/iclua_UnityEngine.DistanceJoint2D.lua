...
---函数名：get_autoConfigureDistance
---@param p1 UnityEngine.DistanceJoint2D
---返回值：System.Boolean
---@return System.Boolean
autoConfigureDistance = function(p1) end,

---函数名：set_autoConfigureDistance
---@param p1 UnityEngine.DistanceJoint2D
autoConfigureDistance = function(p1) end,
...
distance = function(p1) end,

---函数名：set_distance
---@param p1 UnityEngine.DistanceJoint2D
distance = function(p1) end,

---函数名：get_maxDistanceOnly
---@param p1 UnityEngine.DistanceJoint2D
---返回值：System.Boolean
---@return System.Boolean
maxDistanceOnly = function(p1) end,

---函数名：set_maxDistanceOnly
---@param p1 UnityEngine.DistanceJoint2D
maxDistanceOnly = function(p1) end,
