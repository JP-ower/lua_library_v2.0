...
---函数名：add_OnFontAssetRequest
add_OnFontAssetRequest = function() end,

---函数名：remove_OnFontAssetRequest
remove_OnFontAssetRequest = function() end,

---函数名：add_OnSpriteAssetRequest
add_OnSpriteAssetRequest = function() end,

---函数名：remove_OnSpriteAssetRequest
remove_OnSpriteAssetRequest = function() end,
