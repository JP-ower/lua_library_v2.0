...
---函数名：get_alpha
---@param p1 UnityEngine.CanvasGroup
---返回值：System.Single
...
---函数名：get_blocksRaycasts
---@param p1 UnityEngine.CanvasGroup
---返回值：System.Boolean
---@return System.Boolean
blocksRaycasts = function(p1) end,

---函数名：set_blocksRaycasts
---@param p1 UnityEngine.CanvasGroup
blocksRaycasts = function(p1) end,

---函数名：get_ignoreParentGroups
---@param p1 UnityEngine.CanvasGroup
---返回值：System.Boolean
---@return System.Boolean
ignoreParentGroups = function(p1) end,

---函数名：set_ignoreParentGroups
---@param p1 UnityEngine.CanvasGroup
ignoreParentGroups = function(p1) end,
