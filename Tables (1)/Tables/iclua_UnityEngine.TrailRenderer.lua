...
---@param p1 UnityEngine.TrailRenderer
---返回值：Int32
---@return Int32
...
---函数名：get_autodestruct
---@param p1 UnityEngine.TrailRenderer
---返回值：Boolean
---@return Boolean
autodestruct = function(p1) end,

---函数名：set_autodestruct
---@param p1 UnityEngine.TrailRenderer
autodestruct = function(p1) end,
...
---函数名：get_minVertexDistance
---@param p1 UnityEngine.TrailRenderer
---返回值：Single
---@return Single
minVertexDistance = function(p1) end,

---函数名：set_minVertexDistance
---@param p1 UnityEngine.TrailRenderer
minVertexDistance = function(p1) end,
...
SetPosition = function(p1,p2,p3) end,
...
BakeMesh = function(p1,p2,p3) end,
...
BakeMesh = function(p1,p2,p3,p4) end,
...
---@param p1 UnityEngine.TrailRenderer
---@param p2 UnityEngine.Vector3[]
SetPositions = function(p1,p2) end,

---函数名：AddPosition
---@param p1 UnityEngine.TrailRenderer
---@param p2 UnityEngine.Vector3
AddPosition = function(p1,p2) end,

---函数名：AddPositions
---@param p1 UnityEngine.TrailRenderer
---@param p2 UnityEngine.Vector3[]
AddPositions = function(p1,p2) end,
