---@meta
---@class TMPro.TMP_InputField.LineType
TMPro.TMP_InputField.LineType = {
---函数名：Equals
---@param p1 TMPro.TMP_InputField.LineType
...
---返回值：LineType
---@return LineType
SingleLine = function() end,

---函数名：MultiLineSubmit
---返回值：LineType
---@return LineType
MultiLineSubmit = function() end,

---函数名：MultiLineNewline
---返回值：LineType
---@return LineType
MultiLineNewline = function() end,
