...
---函数名：get_speed
---@param p1 UnityEngine.SurfaceEffector2D
---返回值：Single
---@return Single
...
---函数名：get_speedVariation
---@param p1 UnityEngine.SurfaceEffector2D
---返回值：Single
---@return Single
speedVariation = function(p1) end,

---函数名：set_speedVariation
---@param p1 UnityEngine.SurfaceEffector2D
speedVariation = function(p1) end,
...
---返回值：Single
---@return Single
forceScale = function(p1) end,

---函数名：set_forceScale
---@param p1 UnityEngine.SurfaceEffector2D
forceScale = function(p1) end,

---函数名：get_useContactForce
---@param p1 UnityEngine.SurfaceEffector2D
---返回值：Boolean
---@return Boolean
useContactForce = function(p1) end,

---函数名：set_useContactForce
---@param p1 UnityEngine.SurfaceEffector2D
useContactForce = function(p1) end,
