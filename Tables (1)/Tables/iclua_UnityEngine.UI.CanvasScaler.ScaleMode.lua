...
---函数名：Equals
---@param p1 UnityEngine.UI.CanvasScaler.ScaleMode
...
---函数名：ConstantPixelSize
---返回值：ScaleMode
---@return ScaleMode
ConstantPixelSize = function() end,

---函数名：ScaleWithScreenSize
---返回值：ScaleMode
---@return ScaleMode
ScaleWithScreenSize = function() end,

---函数名：ConstantPhysicalSize
---返回值：ScaleMode
---@return ScaleMode
ConstantPhysicalSize = function() end,
