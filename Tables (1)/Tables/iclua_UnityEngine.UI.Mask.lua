...
---@param p1 UnityEngine.UI.Mask
---返回值：UnityEngine.RectTransform
---@return UnityEngine.RectTransform
rectTransform = function(p1) end,

---函数名：get_showMaskGraphic
---@param p1 UnityEngine.UI.Mask
---返回值：System.Boolean
---@return System.Boolean
showMaskGraphic = function(p1) end,

---函数名：set_showMaskGraphic
---@param p1 UnityEngine.UI.Mask
showMaskGraphic = function(p1) end,
...
---返回值：System.Boolean
---@return System.Boolean
MaskEnabled = function(p1) end,

---函数名：OnSiblingGraphicEnabledDisabled
---@param p1 UnityEngine.UI.Mask
OnSiblingGraphicEnabledDisabled = function(p1) end,
