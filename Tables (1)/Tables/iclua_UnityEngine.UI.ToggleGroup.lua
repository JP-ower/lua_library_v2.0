...
---函数名：get_allowSwitchOff
---@param p1 UnityEngine.UI.ToggleGroup
---返回值：System.Boolean
---@return System.Boolean
allowSwitchOff = function(p1) end,

---函数名：set_allowSwitchOff
---@param p1 UnityEngine.UI.ToggleGroup
allowSwitchOff = function(p1) end,

---函数名：NotifyToggleOn
---@param p1 UnityEngine.UI.ToggleGroup
---@param p2 UnityEngine.UI.Toggle
---@param p3 System.Boolean
NotifyToggleOn = function(p1,p2,p3) end,

---函数名：UnregisterToggle
---@param p1 UnityEngine.UI.ToggleGroup
---@param p2 UnityEngine.UI.Toggle
UnregisterToggle = function(p1,p2) end,

---函数名：RegisterToggle
---@param p1 UnityEngine.UI.ToggleGroup
---@param p2 UnityEngine.UI.Toggle
RegisterToggle = function(p1,p2) end,

---函数名：EnsureValidState
---@param p1 UnityEngine.UI.ToggleGroup
EnsureValidState = function(p1) end,

---函数名：AnyTogglesOn
---@param p1 UnityEngine.UI.ToggleGroup
---返回值：System.Boolean
---@return System.Boolean
AnyTogglesOn = function(p1) end,

---函数名：ActiveToggles
---@param p1 UnityEngine.UI.ToggleGroup
---返回值：System.Collections.Generic.IEnumerable`1[[UnityEngine.UI.Toggle, UnityEngine.UI, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null]]
...
ActiveToggles = function(p1) end,

---函数名：GetFirstActiveToggle
---@param p1 UnityEngine.UI.ToggleGroup
---返回值：UnityEngine.UI.Toggle
---@return UnityEngine.UI.Toggle
GetFirstActiveToggle = function(p1) end,

---函数名：SetAllTogglesOff
---@param p1 UnityEngine.UI.ToggleGroup
---@param p2 System.Boolean
SetAllTogglesOff = function(p1,p2) end,
