...
---函数名：Equals
---@param p1 UnityEngine.MaterialGlobalIlluminationFlags
...
---函数名：RealtimeEmissive
---返回值：MaterialGlobalIlluminationFlags
---@return MaterialGlobalIlluminationFlags
RealtimeEmissive = function() end,

---函数名：BakedEmissive
---返回值：MaterialGlobalIlluminationFlags
---@return MaterialGlobalIlluminationFlags
BakedEmissive = function() end,

---函数名：EmissiveIsBlack
---返回值：MaterialGlobalIlluminationFlags
---@return MaterialGlobalIlluminationFlags
EmissiveIsBlack = function() end,

---函数名：AnyEmissive
---返回值：MaterialGlobalIlluminationFlags
---@return MaterialGlobalIlluminationFlags
AnyEmissive = function() end,
