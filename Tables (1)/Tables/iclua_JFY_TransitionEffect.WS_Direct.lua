---@meta
---@class JFY_TransitionEffect.WS_Direct
JFY_TransitionEffect.WS_Direct = {
---函数名：Equals
---@param p1 JFY_TransitionEffect.WS_Direct
...
---函数名：TogetherHorizontal
---返回值：WS_Direct
---@return WS_Direct
TogetherHorizontal = function() end,

---函数名：TogetherVertical
---返回值：WS_Direct
---@return WS_Direct
TogetherVertical = function() end,
