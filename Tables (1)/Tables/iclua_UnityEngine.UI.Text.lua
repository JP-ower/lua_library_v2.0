...
UnityEngine.UI.Text = {
---函数名：get_cachedTextGenerator
---@param p1 UnityEngine.UI.Text
---返回值：UnityEngine.TextGenerator
---@return UnityEngine.TextGenerator
cachedTextGenerator = function(p1) end,

---函数名：get_cachedTextGeneratorForLayout
---@param p1 UnityEngine.UI.Text
---返回值：UnityEngine.TextGenerator
---@return UnityEngine.TextGenerator
cachedTextGeneratorForLayout = function(p1) end,
...
---函数名：FontTextureChanged
---@param p1 UnityEngine.UI.Text
FontTextureChanged = function(p1) end,
...
---函数名：get_supportRichText
---@param p1 UnityEngine.UI.Text
---返回值：System.Boolean
---@return System.Boolean
supportRichText = function(p1) end,

---函数名：set_supportRichText
---@param p1 UnityEngine.UI.Text
supportRichText = function(p1) end,

---函数名：get_resizeTextForBestFit
---@param p1 UnityEngine.UI.Text
---返回值：System.Boolean
---@return System.Boolean
resizeTextForBestFit = function(p1) end,

---函数名：set_resizeTextForBestFit
---@param p1 UnityEngine.UI.Text
resizeTextForBestFit = function(p1) end,

---函数名：get_resizeTextMinSize
---@param p1 UnityEngine.UI.Text
---返回值：System.Int32
---@return System.Int32
resizeTextMinSize = function(p1) end,

---函数名：set_resizeTextMinSize
---@param p1 UnityEngine.UI.Text
resizeTextMinSize = function(p1) end,

---函数名：get_resizeTextMaxSize
---@param p1 UnityEngine.UI.Text
---返回值：System.Int32
---@return System.Int32
resizeTextMaxSize = function(p1) end,

---函数名：set_resizeTextMaxSize
---@param p1 UnityEngine.UI.Text
resizeTextMaxSize = function(p1) end,
...
---函数名：get_alignByGeometry
---@param p1 UnityEngine.UI.Text
---返回值：System.Boolean
---@return System.Boolean
alignByGeometry = function(p1) end,

---函数名：set_alignByGeometry
---@param p1 UnityEngine.UI.Text
alignByGeometry = function(p1) end,
...
---函数名：get_horizontalOverflow
---@param p1 UnityEngine.UI.Text
---返回值：UnityEngine.HorizontalWrapMode
---@return UnityEngine.HorizontalWrapMode
horizontalOverflow = function(p1) end,

---函数名：set_horizontalOverflow
---@param p1 UnityEngine.UI.Text
horizontalOverflow = function(p1) end,

---函数名：get_verticalOverflow
---@param p1 UnityEngine.UI.Text
---返回值：UnityEngine.VerticalWrapMode
---@return UnityEngine.VerticalWrapMode
verticalOverflow = function(p1) end,

---函数名：set_verticalOverflow
---@param p1 UnityEngine.UI.Text
verticalOverflow = function(p1) end,
...
---函数名：GetGenerationSettings
---@param p1 UnityEngine.UI.Text
---@param p2 UnityEngine.Vector2
---返回值：UnityEngine.TextGenerationSettings
---@return UnityEngine.TextGenerationSettings
GetGenerationSettings = function(p1,p2) end,

---函数名：GetTextAnchorPivot
---@param p1 UnityEngine.TextAnchor
---返回值：UnityEngine.Vector2
---@return UnityEngine.Vector2
GetTextAnchorPivot = function(p1) end,
