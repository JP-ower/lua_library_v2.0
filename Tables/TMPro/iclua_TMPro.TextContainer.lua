...
----@return any
---@overload fun(self: TMPro.TextContainer, type: System.Type):UnityEngine.Component[]
---@overload fun(self: TMPro.TextContainer, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: TMPro.TextContainer)
---@overload fun(self: TMPro.TextContainer)
