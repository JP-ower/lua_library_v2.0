...
---函数名：创建UI文本到上一个UI组件<p>
---描述：创建UI文本到上一个UI组件<p>
---@return UI_XText
CreateToLastXRT = function() end,

---函数名：从UI组件上获取UI文本<p>
---描述：从<code>xrt</code>上获取UI文本<p>
---更新版本：2.7563<p>
---@param xrt UI_XRT
---@return UI_XText
...
---函数名：从UI组件上查找UI文本<p>
---描述：从<code>xrt</code>上查找名字为<code>name</code>的UI文本<p>
---@param xrt UI_XRT
---@param name System.String
---@return UI_XText
FindXText = function(xrt,name) end,

---函数名：从UI组件上查找UI文本(标签)<p>
---描述：从<code>xrt</code>上查找标签为<code>tag</code>的UI文本<p>
---更新版本：2.7597<p>
---@param xrt UI_XRT
---@param tag System.String
---@return UI_XText
FindXText_Tag = function(xrt,tag) end,
...
---函数名：文本文字高度<p>
---描述：<code>self</code>的文本文字高度<p>
---@param self UI_XText
---@return System.Single
GetPreferredHeight = function(self) end,

---函数名：文本文字宽度<p>
---描述：<code>self</code>的文本文字宽度<p>
---@param self UI_XText
---@return System.Single
GetPreferredWidth = function(self) end,
...
---函数名：设置富文本开启状态<p>
---描述：设置<code>self</code>的富文本开启状态为<code>be</code><p>
---更新版本：2.781<p>
---@param self UI_XText
---@param be System.Boolean
SetSupportRichText = function(self,be) end,

---函数名：富文本是开启的<p>
---描述：<code>self</code>的富文本是开启的<p>
---更新版本：2.781<p>
---@param self UI_XText
---@return System.Boolean
GetSupportRichText = function(self) end,
