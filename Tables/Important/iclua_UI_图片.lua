...
---函数名：创建UI图片到上一个UI组件<p>
---描述：创建UI图片到上一个UI组件<p>
---@return UI_XImage
CreateToLastXRT = function() end,

---函数名：从UI组件上获取UI图片<p>
---描述：从<code>xrt</code>上获取UI图片<p>
---更新版本：2.7563<p>
---@param xrt UI_XRT
---@return UI_XImage
GetXImage = function(xrt) end,

---函数名：从UI组件上获取UI图片(废弃的)<p>
---描述：从<code>xrt</code>上获取UI图片<p>
---更新版本：2.7563<p>
---@param xrt UI_XRT
---@return UI_XImage
GetXText = function(xrt) end,
...
---描述：从<code>xrt</code>上查找标签为<code>tag</code>的UI图片<p>
---更新版本：2.7597<p>
---@param xrt UI_XRT
...
---函数名：设置图片<p>
---描述：设置<code>self</code>的图片为<code>sp</code><p>
---@param self UI_XImage
---@param sp UnityEngine.Sprite
SetSprite = function(self,sp) end,

---函数名：图片<p>
---描述：<code>self</code>的图片<p><code>sp</code>
---@param self UI_XImage
---@param sp UnityEngine.Sprite
---@return UnityEngine.Sprite
GetSprite = function(self,sp) end,
...
---函数名：设置图片渲染模式<p>
---描述：设置<code>self</code>的图片渲染模式为<code>type</code><p>
---@param self UI_XImage
---@param type UnityEngine.UI.Image.Type
SetImageType = function(self,type) end,

---函数名：图片渲染模式<p>
---描述：<code>self</code>的图片渲染模式<p>
---@param self UI_XImage
---@return UnityEngine.UI.Image.Type
GetImageType = function(self) end,

---函数名：设置图片颜色<p>
---描述：设置<code>self</code>的图片颜色为<code>c</code><p>
---@param self UI_XImage
---@param c UnityEngine.Color
SetColor = function(self,c) end,

---函数名：图片颜色<p>
---描述：<code>self</code>的图片颜色<p>
---@param self UI_XImage
...
---函数名：设置响应点击事件所需最低透明度<p>
---描述：设置<code>self</code>响应点击事件所需最低透明度为<code>a</code><p>
---更新版本：2.7584<p>
---@param self UI_XImage
---@param a System.Single
SetAlphaHitTestMinimumThreshold = function(self,a) end,

---函数名：响应点击事件所需最低透明度<p>
---描述：<code>self</code>响应点击事件所需的最低透明度<p>
---更新版本：2.7584<p>
---@param self UI_XImage
---@return System.Single
GetAlphaHitTestMinimumThreshold = function(self) end,
