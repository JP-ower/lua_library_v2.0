...
---函数名：遮罩图片<p>
---描述：<code>self</code>的遮罩图片<p><code>sp</code>
---@param self UI_XMask
...
---函数名：遮罩图形是显示的<p>
---描述：<code>self</code>的遮罩图形是显示的<p>
---@param self UI_XMask
---@return System.Boolean
IsShowMaskGraphic = function(self) end,
...
---函数名：设置是否显示遮罩图形<p>
---描述：设置<code>self</code>的遮罩图形显示状态为<code>be</code><p>
---@param self UI_XMask
---@param be System.Boolean
SetShowMaskGraphic = function(self,be) end,
...
---函数名：设置遮罩图片<p>
---描述：设置<code>self</code>的遮罩图片为<code>sp</code><p>
---@param self UI_XMask
---@param sp UnityEngine.Sprite
