...
---函数名：IsFilteringNormalAngle<p>
---@overload fun(self: UnityEngine.ContactFilter2D, normal: UnityEngine.Vector2):System.Boolean
---@overload fun(self: UnityEngine.ContactFilter2D, angle: System.Single):System.Boolean
IsFilteringNormalAngle = function(...) end,
