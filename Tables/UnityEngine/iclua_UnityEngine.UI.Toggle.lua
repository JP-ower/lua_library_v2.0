...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: UnityEngine.UI.Toggle, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: UnityEngine.UI.Toggle, methodName: System.String)
---@overload fun(self: UnityEngine.UI.Toggle, methodName: System.String, parameter: System.Object)
---@overload fun(self: UnityEngine.UI.Toggle, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: UnityEngine.UI.Toggle)
---@overload fun(self: UnityEngine.UI.Toggle, methodName: System.String)
...
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: UnityEngine.UI.Toggle):any
---@overload fun(self: UnityEngine.UI.Toggle, type: System.Type):UnityEngine.Component
---@overload fun(self: UnityEngine.UI.Toggle, type: System.String):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: UnityEngine.UI.Toggle, t: System.Type):UnityEngine.Component
---@overload fun(self: UnityEngine.UI.Toggle, includeInactive: System.Boolean):any
---@overload fun(self: UnityEngine.UI.Toggle):any
---@overload fun(self: UnityEngine.UI.Toggle, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
...
---@overload fun(self: UnityEngine.UI.Toggle)
---@overload fun(self: UnityEngine.UI.Toggle)
---@overload fun(self: UnityEngine.UI.Toggle, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: UnityEngine.UI.Toggle, type: System.Type):UnityEngine.Component[]
...
---@overload fun(self: UnityEngine.UI.Toggle)
---@overload fun(self: UnityEngine.UI.Toggle)
---@overload fun(self: UnityEngine.UI.Toggle, includeInactive: System.Boolean)
---@overload fun(self: UnityEngine.UI.Toggle, includeInactive: System.Boolean)
---@overload fun(self: UnityEngine.UI.Toggle, t: System.Type):UnityEngine.Component[]
---@overload fun(self: UnityEngine.UI.Toggle, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: UnityEngine.UI.Toggle, methodName: System.String):System.Boolean
---@overload fun(self: UnityEngine.UI.Toggle):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: UnityEngine.UI.Toggle, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: UnityEngine.UI.Toggle, methodName: System.String, value: System.Object)
---@overload fun(self: UnityEngine.UI.Toggle, methodName: System.String)
---@overload fun(self: UnityEngine.UI.Toggle, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: UnityEngine.UI.Toggle, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: UnityEngine.UI.Toggle, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
---@overload fun(self: UnityEngine.UI.Toggle, methodName: System.String, value: System.Object):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: UnityEngine.UI.Toggle, routine: System.Collections.IEnumerator)
---@overload fun(self: UnityEngine.UI.Toggle, routine: UnityEngine.Coroutine)
---@overload fun(self: UnityEngine.UI.Toggle, methodName: System.String)
StopCoroutine = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: UnityEngine.UI.Toggle, type: System.Type, component: UnityEngine.Component&):System.Boolean
---@overload fun(self: UnityEngine.UI.Toggle):System.Boolean
TryGetComponent = function(...) end,

---函数名：CompareTag<p>
---@param self UnityEngine.UI.Toggle
...
---函数名：SetIsOnWithoutNotify<p>
---@param self UnityEngine.UI.Toggle
---@param value System.Boolean
SetIsOnWithoutNotify = function(self,value) end,
