...
---函数名：GetComponents<p>
----@return any
---@overload fun(self: UnityEngine.UI.ScrollRect, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: UnityEngine.UI.ScrollRect, type: System.Type):UnityEngine.Component[]
---@overload fun(self: UnityEngine.UI.ScrollRect)
---@overload fun(self: UnityEngine.UI.ScrollRect)
