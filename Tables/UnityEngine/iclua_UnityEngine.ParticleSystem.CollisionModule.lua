...
---函数名：RemovePlane<p>
---函数名：RemovePlane<p>
---@overload fun(self: UnityEngine.ParticleSystem.CollisionModule, index: System.Int32)
---@overload fun(self: UnityEngine.ParticleSystem.CollisionModule, transform: UnityEngine.Transform)
RemovePlane = function(...) end,
