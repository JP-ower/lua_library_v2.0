...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: UnityEngine.TrailRenderer, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: UnityEngine.TrailRenderer, methodName: System.String)
---@overload fun(self: UnityEngine.TrailRenderer, methodName: System.String, parameter: System.Object)
---@overload fun(self: UnityEngine.TrailRenderer, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：GetComponent<p>
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: UnityEngine.TrailRenderer, type: System.String):UnityEngine.Component
---@overload fun(self: UnityEngine.TrailRenderer):any
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: UnityEngine.TrailRenderer, includeInactive: System.Boolean):any
---@overload fun(self: UnityEngine.TrailRenderer, t: System.Type):UnityEngine.Component
---@overload fun(self: UnityEngine.TrailRenderer, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: UnityEngine.TrailRenderer):any
...
---@overload fun(self: UnityEngine.TrailRenderer, t: System.Type):UnityEngine.Component[]
---@overload fun(self: UnityEngine.TrailRenderer)
---@overload fun(self: UnityEngine.TrailRenderer, includeInactive: System.Boolean)
---@overload fun(self: UnityEngine.TrailRenderer, includeInactive: System.Boolean)
---@overload fun(self: UnityEngine.TrailRenderer, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
---@overload fun(self: UnityEngine.TrailRenderer)
...
---函数名：GetPropertyBlock<p>
---@overload fun(self: UnityEngine.TrailRenderer, properties: UnityEngine.MaterialPropertyBlock, materialIndex: System.Int32)
---@overload fun(self: UnityEngine.TrailRenderer, properties: UnityEngine.MaterialPropertyBlock)
...
---函数名：SendMessage<p>
---函数名：SendMessage<p>
---@overload fun(self: UnityEngine.TrailRenderer, methodName: System.String, value: System.Object)
---@overload fun(self: UnityEngine.TrailRenderer, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: UnityEngine.TrailRenderer, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: UnityEngine.TrailRenderer, methodName: System.String)
