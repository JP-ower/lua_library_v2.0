...
CanStreamedLevelBeLoaded = function(...) end,

---函数名：CaptureScreenshot<p>
---函数名：CaptureScreenshot<p>
---@overload fun(filename: System.String, superSize: System.Int32)
...
GetStreamProgressForLevel = function(...) end,

---函数名：LoadLevel<p>
---函数名：LoadLevel<p>
---@overload fun(index: System.Int32)
---@overload fun(name: System.String)
LoadLevel = function(...) end,

---函数名：LoadLevelAdditive<p>
---函数名：LoadLevelAdditive<p>
---@overload fun(name: System.String)
---@overload fun(index: System.Int32)
LoadLevelAdditive = function(...) end,
...
LoadLevelAdditiveAsync = function(...) end,

---函数名：LoadLevelAsync<p>
---函数名：LoadLevelAsync<p>
---@overload fun(levelName: System.String):UnityEngine.AsyncOperation
---@overload fun(index: System.Int32):UnityEngine.AsyncOperation
LoadLevelAsync = function(...) end,

---函数名：Quit<p>
---函数名：Quit<p>
---@overload fun()
---@overload fun(exitCode: System.Int32)
Quit = function(...) end,
