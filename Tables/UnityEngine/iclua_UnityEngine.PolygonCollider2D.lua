...
GetPath = function(self,index) end,

---函数名：SetPath<p>
---@param self UnityEngine.PolygonCollider2D
---@param index System.Int32
---@param points UnityEngine.Vector2[]
SetPath = function(self,index,points) end,
...
---@return System.Int32
GetPath = function(self,index,points) end,
...
CreatePrimitive = function(self,sides) end,

---函数名：CreatePrimitive<p>
---@param self UnityEngine.PolygonCollider2D
---@param sides System.Int32
---@param scale UnityEngine.Vector2
CreatePrimitive = function(self,sides,scale) end,
...
CreatePrimitive = function(self,sides,scale,offset) end,
