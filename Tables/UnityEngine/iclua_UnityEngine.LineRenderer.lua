...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: UnityEngine.LineRenderer, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: UnityEngine.LineRenderer, methodName: System.String)
---@overload fun(self: UnityEngine.LineRenderer, methodName: System.String, parameter: System.Object)
---@overload fun(self: UnityEngine.LineRenderer, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：GetComponent<p>
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: UnityEngine.LineRenderer):any
---@overload fun(self: UnityEngine.LineRenderer, type: System.String):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: UnityEngine.LineRenderer, t: System.Type):UnityEngine.Component
---@overload fun(self: UnityEngine.LineRenderer, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: UnityEngine.LineRenderer, includeInactive: System.Boolean):any
---@overload fun(self: UnityEngine.LineRenderer):any
...
---@overload fun(self: UnityEngine.LineRenderer, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
---@overload fun(self: UnityEngine.LineRenderer, t: System.Type):UnityEngine.Component[]
---@overload fun(self: UnityEngine.LineRenderer, includeInactive: System.Boolean)
---@overload fun(self: UnityEngine.LineRenderer, includeInactive: System.Boolean)
---@overload fun(self: UnityEngine.LineRenderer)
...
---函数名：GetPropertyBlock<p>
---@overload fun(self: UnityEngine.LineRenderer, properties: UnityEngine.MaterialPropertyBlock, materialIndex: System.Int32)
---@overload fun(self: UnityEngine.LineRenderer, properties: UnityEngine.MaterialPropertyBlock)
...
---函数名：SendMessage<p>
---@overload fun(self: UnityEngine.LineRenderer, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: UnityEngine.LineRenderer, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: UnityEngine.LineRenderer, methodName: System.String)
---@overload fun(self: UnityEngine.LineRenderer, methodName: System.String, value: System.Object)
...
SetColors = function(self,start,_end) end,
...
---函数名：SetVertexCount<p>
---@param self UnityEngine.LineRenderer
---@param count System.Int32
SetVertexCount = function(self,count) end,

---函数名：SetWidth<p>
---@param self UnityEngine.LineRenderer
---@param start System.Single
---@param _end System.Single
SetWidth = function(self,start,_end) end,

---函数名：Simplify<p>
---@param self UnityEngine.LineRenderer
---@param tolerance System.Single
Simplify = function(self,tolerance) end,
