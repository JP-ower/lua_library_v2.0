...
---@overload fun(self: UnityEngine.PlatformEffector2D, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: UnityEngine.PlatformEffector2D, type: System.Type):UnityEngine.Component[]
---@overload fun(self: UnityEngine.PlatformEffector2D)
