...
---@overload fun(self: UnityEngine.FrictionJoint2D)
---@overload fun(self: UnityEngine.FrictionJoint2D, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: UnityEngine.FrictionJoint2D, type: System.Type):UnityEngine.Component[]
