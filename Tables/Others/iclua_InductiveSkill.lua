...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: InductiveSkill, methodName: System.String, parameter: System.Object)
---@overload fun(self: InductiveSkill, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: InductiveSkill, methodName: System.String)
---@overload fun(self: InductiveSkill, methodName: System.String, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: InductiveSkill, methodName: System.String)
---@overload fun(self: InductiveSkill)
CancelInvoke = function(...) end,

---函数名：GetComponent<p>
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: InductiveSkill, type: System.Type):UnityEngine.Component
---@overload fun(self: InductiveSkill):any
---@overload fun(self: InductiveSkill, type: System.String):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: InductiveSkill, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: InductiveSkill, t: System.Type):UnityEngine.Component
---@overload fun(self: InductiveSkill, includeInactive: System.Boolean):any
---@overload fun(self: InductiveSkill):any
...
---@overload fun(self: InductiveSkill)
---@overload fun(self: InductiveSkill)
---@overload fun(self: InductiveSkill, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: InductiveSkill, type: System.Type):UnityEngine.Component[]
...
---@overload fun(self: InductiveSkill)
---@overload fun(self: InductiveSkill)
---@overload fun(self: InductiveSkill, includeInactive: System.Boolean)
---@overload fun(self: InductiveSkill, includeInactive: System.Boolean)
---@overload fun(self: InductiveSkill, t: System.Type):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: InductiveSkill):System.Boolean
---@overload fun(self: InductiveSkill, methodName: System.String):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: InductiveSkill, methodName: System.String)
---@overload fun(self: InductiveSkill, methodName: System.String, value: System.Object)
---@overload fun(self: InductiveSkill, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: InductiveSkill, methodName: System.String, options: UnityEngine.SendMessageOptions)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: InductiveSkill, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
---@overload fun(self: InductiveSkill, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: InductiveSkill, methodName: System.String):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: InductiveSkill, routine: UnityEngine.Coroutine)
---@overload fun(self: InductiveSkill, methodName: System.String)
---@overload fun(self: InductiveSkill, routine: System.Collections.IEnumerator)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: InductiveSkill, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: InductiveSkill, unit: Unit):System.Boolean
TargetDetection = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: InductiveSkill, type: System.Type, component: UnityEngine.Component&):System.Boolean
---@overload fun(self: InductiveSkill):System.Boolean
TryGetComponent = function(...) end,

---函数名：AddControlKey<p>
---@param self InductiveSkill
---@param ck ControlKey
