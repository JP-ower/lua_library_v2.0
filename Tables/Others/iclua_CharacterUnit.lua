...
---函数名：添加力<p>
---@overload fun(self: CharacterUnit, f: UnityEngine.Vector2, fm?: UnityEngine.ForceMode2D default:Force)
---@overload fun(self: CharacterUnit, f: UnityEngine.Vector2, fm?: UnityEngine.ForceMode2D default:Force)
AddForce = function(...) end,

---函数名：AddSkill<p>
---函数名：AddSkill<p>
---@overload fun(self: CharacterUnit, sk: Skill):Skill
---@overload fun(self: CharacterUnit, type: System.Type):Skill
...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: CharacterUnit, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: CharacterUnit, methodName: System.String, parameter: System.Object)
---@overload fun(self: CharacterUnit, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: CharacterUnit, methodName: System.String)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: CharacterUnit)
---@overload fun(self: CharacterUnit, methodName: System.String)
...
---@overload fun(self: CharacterUnit)
---@overload fun(self: CharacterUnit)
ClearForce_Y = function(...) end,

---函数名：GetComponent<p>
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: CharacterUnit, type: System.Type):UnityEngine.Component
---@overload fun(self: CharacterUnit):any
---@overload fun(self: CharacterUnit, type: System.String):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: CharacterUnit, includeInactive: System.Boolean):any
---@overload fun(self: CharacterUnit, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: CharacterUnit, t: System.Type):UnityEngine.Component
---@overload fun(self: CharacterUnit):any
...
---@overload fun(self: CharacterUnit)
---@overload fun(self: CharacterUnit, type: System.Type):UnityEngine.Component[]
---@overload fun(self: CharacterUnit, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: CharacterUnit)
...
----@return any
---函数名：GetComponentsInChildren<p>
---@overload fun(self: CharacterUnit, includeInactive: System.Boolean)
---@overload fun(self: CharacterUnit)
---@overload fun(self: CharacterUnit, includeInactive: System.Boolean)
---@overload fun(self: CharacterUnit, t: System.Type):UnityEngine.Component[]
---@overload fun(self: CharacterUnit)
...
---@overload fun(self: CharacterUnit):System.Single
---@overload fun(self: CharacterUnit):System.Single
GetGravityScale = function(...) end,

---函数名：GetSkill<p>
---函数名：GetSkill<p>
---函数名：GetSkill<p>
---@overload fun(self: CharacterUnit, ck: ControlKey):Skill
---@overload fun(self: CharacterUnit, type: System.Type):Skill
---@overload fun(self: CharacterUnit, id: System.String):Skill
GetSkill = function(...) end,

---函数名：速率<p>
---描述：<code>self</code>的运动速率<p>
---函数名：速率<p>
---@overload fun(self: CharacterUnit):UnityEngine.Vector2
---@overload fun(self: CharacterUnit):UnityEngine.Vector2
...
---@overload fun(self: CharacterUnit):System.Single
---@overload fun(self: CharacterUnit):System.Single
GetVelocity_Y = function(...) end,

---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: CharacterUnit):System.Boolean
---@overload fun(self: CharacterUnit, methodName: System.String):System.Boolean
IsInvoking = function(...) end,

---函数名：RemoveSkill<p>
---函数名：RemoveSkill<p>
---@overload fun(self: CharacterUnit, type: System.Type)
---@overload fun(self: CharacterUnit, sk: Skill)
...
---函数名：SendMessage<p>
---@overload fun(self: CharacterUnit, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: CharacterUnit, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: CharacterUnit, methodName: System.String)
---@overload fun(self: CharacterUnit, methodName: System.String, value: System.Object)
...
---介绍：只对单位类型为 [物理单位] 或者 [角色单位] 的单位生效<p>
---@overload fun(self: CharacterUnit, scale: System.Single)
---@overload fun(self: CharacterUnit, scale: System.Single)
...
---介绍：只对单位类型为 [物理单位] 或者 [角色单位] 的单位生效<p>
---函数名：设置速率<p>
---@overload fun(self: CharacterUnit, v: UnityEngine.Vector2)
---@overload fun(self: CharacterUnit, v: UnityEngine.Vector2)
...
---介绍：只对单位类型为 [物理单位] 或者 [角色单位] 的单位生效<p>
---函数名：设置速率(x轴)<p>
---@overload fun(self: CharacterUnit, v: System.Single)
---@overload fun(self: CharacterUnit, v: System.Single)
SetVelocity_X = function(...) end,
...
---@overload fun(self: CharacterUnit, v: System.Single)
---@overload fun(self: CharacterUnit, v: System.Single)
SetVelocity_Y = function(...) end,

---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: CharacterUnit, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
---@overload fun(self: CharacterUnit, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: CharacterUnit, methodName: System.String):UnityEngine.Coroutine
...
---函数名：StopCoroutine<p>
---@overload fun(self: CharacterUnit, methodName: System.String)
---@overload fun(self: CharacterUnit, routine: UnityEngine.Coroutine)
---@overload fun(self: CharacterUnit, routine: System.Collections.IEnumerator)
StopCoroutine = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: CharacterUnit, type: System.Type, component: UnityEngine.Component&):System.Boolean
---@overload fun(self: CharacterUnit):System.Boolean
TryGetComponent = function(...) end,

---函数名：UpdatePos<p>
---函数名：UpdatePos<p>
---@overload fun(self: CharacterUnit, pivot: UnityEngine.Vector2, size: UnityEngine.Vector2)
---@overload fun(self: CharacterUnit, pivot: UnityEngine.Vector2)
