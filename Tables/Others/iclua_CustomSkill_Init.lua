...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: CustomSkill_Init, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: CustomSkill_Init, methodName: System.String)
---@overload fun(self: CustomSkill_Init, methodName: System.String, parameter: System.Object)
---@overload fun(self: CustomSkill_Init, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: CustomSkill_Init)
---@overload fun(self: CustomSkill_Init, methodName: System.String)
...
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: CustomSkill_Init, type: System.Type):UnityEngine.Component
---@overload fun(self: CustomSkill_Init):any
---@overload fun(self: CustomSkill_Init, type: System.String):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: CustomSkill_Init, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: CustomSkill_Init, t: System.Type):UnityEngine.Component
---@overload fun(self: CustomSkill_Init, includeInactive: System.Boolean):any
---@overload fun(self: CustomSkill_Init):any
...
----@return any
---@overload fun(self: CustomSkill_Init)
---@overload fun(self: CustomSkill_Init, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: CustomSkill_Init, type: System.Type):UnityEngine.Component[]
---@overload fun(self: CustomSkill_Init)
...
---@overload fun(self: CustomSkill_Init)
---@overload fun(self: CustomSkill_Init)
---@overload fun(self: CustomSkill_Init, includeInactive: System.Boolean)
---@overload fun(self: CustomSkill_Init, includeInactive: System.Boolean)
---@overload fun(self: CustomSkill_Init, t: System.Type):UnityEngine.Component[]
---@overload fun(self: CustomSkill_Init, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: CustomSkill_Init):System.Boolean
---@overload fun(self: CustomSkill_Init, methodName: System.String):System.Boolean
...
---函数名：SendMessage<p>
---函数名：SendMessage<p>
---@overload fun(self: CustomSkill_Init, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: CustomSkill_Init, methodName: System.String)
---@overload fun(self: CustomSkill_Init, methodName: System.String, value: System.Object)
---@overload fun(self: CustomSkill_Init, methodName: System.String, options: UnityEngine.SendMessageOptions)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: CustomSkill_Init, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
---@overload fun(self: CustomSkill_Init, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: CustomSkill_Init, methodName: System.String, value: System.Object):UnityEngine.Coroutine
...
---函数名：StopCoroutine<p>
---@overload fun(self: CustomSkill_Init, methodName: System.String)
---@overload fun(self: CustomSkill_Init, routine: UnityEngine.Coroutine)
---@overload fun(self: CustomSkill_Init, routine: System.Collections.IEnumerator)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: CustomSkill_Init, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: CustomSkill_Init, unit: Unit):System.Boolean
TargetDetection = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: CustomSkill_Init, type: System.Type, component: UnityEngine.Component&):System.Boolean
---@overload fun(self: CustomSkill_Init):System.Boolean
TryGetComponent = function(...) end,

---函数名：AddControlKey<p>
---@param self CustomSkill_Init
---@param ck ControlKey
