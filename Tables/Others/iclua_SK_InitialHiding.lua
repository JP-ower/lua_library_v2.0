...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: SK_InitialHiding, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_InitialHiding, methodName: System.String)
---@overload fun(self: SK_InitialHiding, methodName: System.String, parameter: System.Object)
---@overload fun(self: SK_InitialHiding, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: SK_InitialHiding)
---@overload fun(self: SK_InitialHiding, methodName: System.String)
...
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: SK_InitialHiding):any
---@overload fun(self: SK_InitialHiding, type: System.String):UnityEngine.Component
---@overload fun(self: SK_InitialHiding, type: System.Type):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: SK_InitialHiding, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: SK_InitialHiding, t: System.Type):UnityEngine.Component
---@overload fun(self: SK_InitialHiding, includeInactive: System.Boolean):any
---@overload fun(self: SK_InitialHiding):any
...
---@overload fun(self: SK_InitialHiding)
---@overload fun(self: SK_InitialHiding)
---@overload fun(self: SK_InitialHiding, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
...
---@overload fun(self: SK_InitialHiding)
---@overload fun(self: SK_InitialHiding)
---@overload fun(self: SK_InitialHiding, includeInactive: System.Boolean)
---@overload fun(self: SK_InitialHiding, includeInactive: System.Boolean)
---@overload fun(self: SK_InitialHiding, t: System.Type):UnityEngine.Component[]
---@overload fun(self: SK_InitialHiding, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: SK_InitialHiding, methodName: System.String):System.Boolean
---@overload fun(self: SK_InitialHiding):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: SK_InitialHiding, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_InitialHiding, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_InitialHiding, methodName: System.String)
---@overload fun(self: SK_InitialHiding, methodName: System.String, value: System.Object)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: SK_InitialHiding, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: SK_InitialHiding, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
---@overload fun(self: SK_InitialHiding, methodName: System.String):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: SK_InitialHiding, routine: System.Collections.IEnumerator)
---@overload fun(self: SK_InitialHiding, routine: UnityEngine.Coroutine)
---@overload fun(self: SK_InitialHiding, methodName: System.String)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: SK_InitialHiding, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: SK_InitialHiding, unit: Unit):System.Boolean
TargetDetection = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: SK_InitialHiding, type: System.Type, component: UnityEngine.Component&):System.Boolean
---@overload fun(self: SK_InitialHiding):System.Boolean
TryGetComponent = function(...) end,

---函数名：AddControlKey<p>
---@param self SK_InitialHiding
---@param ck ControlKey
