...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: SK_JumpRegion, methodName: System.String, parameter: System.Object)
---@overload fun(self: SK_JumpRegion, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_JumpRegion, methodName: System.String)
---@overload fun(self: SK_JumpRegion, methodName: System.String, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: SK_JumpRegion, methodName: System.String)
---@overload fun(self: SK_JumpRegion)
CancelInvoke = function(...) end,

---函数名：GetComponent<p>
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: SK_JumpRegion, type: System.Type):UnityEngine.Component
---@overload fun(self: SK_JumpRegion):any
---@overload fun(self: SK_JumpRegion, type: System.String):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: SK_JumpRegion, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: SK_JumpRegion, t: System.Type):UnityEngine.Component
---@overload fun(self: SK_JumpRegion, includeInactive: System.Boolean):any
---@overload fun(self: SK_JumpRegion):any
...
---@overload fun(self: SK_JumpRegion)
---@overload fun(self: SK_JumpRegion)
---@overload fun(self: SK_JumpRegion, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: SK_JumpRegion, type: System.Type):UnityEngine.Component[]
...
---@overload fun(self: SK_JumpRegion)
---@overload fun(self: SK_JumpRegion)
---@overload fun(self: SK_JumpRegion, includeInactive: System.Boolean)
---@overload fun(self: SK_JumpRegion, includeInactive: System.Boolean)
---@overload fun(self: SK_JumpRegion, t: System.Type):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: SK_JumpRegion):System.Boolean
---@overload fun(self: SK_JumpRegion, methodName: System.String):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: SK_JumpRegion, methodName: System.String)
---@overload fun(self: SK_JumpRegion, methodName: System.String, value: System.Object)
---@overload fun(self: SK_JumpRegion, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_JumpRegion, methodName: System.String, options: UnityEngine.SendMessageOptions)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: SK_JumpRegion, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: SK_JumpRegion, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
---@overload fun(self: SK_JumpRegion, methodName: System.String, value: System.Object):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: SK_JumpRegion, routine: UnityEngine.Coroutine)
---@overload fun(self: SK_JumpRegion, methodName: System.String)
---@overload fun(self: SK_JumpRegion, routine: System.Collections.IEnumerator)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: SK_JumpRegion, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: SK_JumpRegion, unit: Unit):System.Boolean
TargetDetection = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: SK_JumpRegion, type: System.Type, component: UnityEngine.Component&):System.Boolean
---@overload fun(self: SK_JumpRegion):System.Boolean
TryGetComponent = function(...) end,

---函数名：AddControlKey<p>
---@param self SK_JumpRegion
---@param ck ControlKey
...
Enter_Unit = function(self,targetUnit) end,
...
---@param self SK_JumpRegion
---@param targetUnit Unit
Exit_Unit = function(self,targetUnit) end,
...
---函数名：OnJump<p>
---@param self SK_JumpRegion
---@param pc SK_PlayerControl
OnJump = function(self,pc) end,
...
---字段名：exitMaxJumpCount<p>
---@type System.Int32
exitMaxJumpCount = nil,

---字段名：exitMinJumpCount<p>
---@type System.Int32
exitMinJumpCount = nil,

---字段名：exitReJumpCount<p>
---@type System.Boolean
exitReJumpCount = nil,
...
---字段名：useEnterJumpCount<p>
---@type System.Boolean
useEnterJumpCount = nil,
