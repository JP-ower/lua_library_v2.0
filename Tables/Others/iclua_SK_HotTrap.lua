...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: SK_HotTrap, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_HotTrap, methodName: System.String)
---@overload fun(self: SK_HotTrap, methodName: System.String, parameter: System.Object)
---@overload fun(self: SK_HotTrap, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: SK_HotTrap)
---@overload fun(self: SK_HotTrap, methodName: System.String)
...
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: SK_HotTrap, type: System.Type):UnityEngine.Component
---@overload fun(self: SK_HotTrap, type: System.String):UnityEngine.Component
---@overload fun(self: SK_HotTrap):any
...
---函数名：GetComponentInChildren<p>
---@overload fun(self: SK_HotTrap):any
---@overload fun(self: SK_HotTrap, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: SK_HotTrap, t: System.Type):UnityEngine.Component
---@overload fun(self: SK_HotTrap, includeInactive: System.Boolean):any
...
----@return any
---函数名：GetComponents<p>
---@overload fun(self: SK_HotTrap, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: SK_HotTrap)
---@overload fun(self: SK_HotTrap)
---@overload fun(self: SK_HotTrap, type: System.Type):UnityEngine.Component[]
...
---@overload fun(self: SK_HotTrap)
---@overload fun(self: SK_HotTrap)
---@overload fun(self: SK_HotTrap, includeInactive: System.Boolean)
---@overload fun(self: SK_HotTrap, includeInactive: System.Boolean)
---@overload fun(self: SK_HotTrap, t: System.Type):UnityEngine.Component[]
---@overload fun(self: SK_HotTrap, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: SK_HotTrap, methodName: System.String):System.Boolean
---@overload fun(self: SK_HotTrap):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: SK_HotTrap, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_HotTrap, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_HotTrap, methodName: System.String)
---@overload fun(self: SK_HotTrap, methodName: System.String, value: System.Object)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: SK_HotTrap, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
---@overload fun(self: SK_HotTrap, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: SK_HotTrap, methodName: System.String, value: System.Object):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: SK_HotTrap, routine: System.Collections.IEnumerator)
---@overload fun(self: SK_HotTrap, methodName: System.String)
---@overload fun(self: SK_HotTrap, routine: UnityEngine.Coroutine)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: SK_HotTrap, unit: Unit):System.Boolean
---@overload fun(self: SK_HotTrap, unit: Unit, affectTargetType: System.String):System.Boolean
TargetDetection = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: SK_HotTrap, type: System.Type, component: UnityEngine.Component&):System.Boolean
---@overload fun(self: SK_HotTrap):System.Boolean
TryGetComponent = function(...) end,

---函数名：AddControlKey<p>
---@param self SK_HotTrap
---@param ck ControlKey
