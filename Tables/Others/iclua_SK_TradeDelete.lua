...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: SK_TradeDelete, methodName: System.String, parameter: System.Object)
---@overload fun(self: SK_TradeDelete, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_TradeDelete, methodName: System.String)
---@overload fun(self: SK_TradeDelete, methodName: System.String, options: UnityEngine.SendMessageOptions)
...
---@overload fun(self: SK_TradeDelete, grd: GameResourceData):System.Boolean
Check = function(...) end,

---函数名：GetComponent<p>
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: SK_TradeDelete, type: System.String):UnityEngine.Component
---@overload fun(self: SK_TradeDelete):any
...
---函数名：GetComponentInChildren<p>
---@overload fun(self: SK_TradeDelete):any
---@overload fun(self: SK_TradeDelete, t: System.Type):UnityEngine.Component
---@overload fun(self: SK_TradeDelete, includeInactive: System.Boolean):any
---@overload fun(self: SK_TradeDelete, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
...
---@overload fun(self: SK_TradeDelete)
---@overload fun(self: SK_TradeDelete)
---@overload fun(self: SK_TradeDelete, includeInactive: System.Boolean)
---@overload fun(self: SK_TradeDelete, includeInactive: System.Boolean)
---@overload fun(self: SK_TradeDelete, t: System.Type):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: SK_TradeDelete, methodName: System.String):System.Boolean
---@overload fun(self: SK_TradeDelete):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: SK_TradeDelete, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_TradeDelete, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_TradeDelete, methodName: System.String)
---@overload fun(self: SK_TradeDelete, methodName: System.String, value: System.Object)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: SK_TradeDelete, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: SK_TradeDelete, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: SK_TradeDelete, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: SK_TradeDelete, routine: UnityEngine.Coroutine)
---@overload fun(self: SK_TradeDelete, routine: System.Collections.IEnumerator)
---@overload fun(self: SK_TradeDelete, methodName: System.String)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: SK_TradeDelete, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: SK_TradeDelete, unit: Unit):System.Boolean
TargetDetection = function(...) end,

---函数名：Trade<p>
---函数名：Trade<p>
---@overload fun(self: SK_TradeDelete, dc: System.Boolean)
---@overload fun(self: SK_TradeDelete)
Trade = function(...) end,
