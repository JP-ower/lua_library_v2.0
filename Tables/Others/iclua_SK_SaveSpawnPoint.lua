...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: SK_SaveSpawnPoint, methodName: System.String, parameter: System.Object)
---@overload fun(self: SK_SaveSpawnPoint, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_SaveSpawnPoint, methodName: System.String)
---@overload fun(self: SK_SaveSpawnPoint, methodName: System.String, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: SK_SaveSpawnPoint)
---@overload fun(self: SK_SaveSpawnPoint, methodName: System.String)
...
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: SK_SaveSpawnPoint, type: System.Type):UnityEngine.Component
---@overload fun(self: SK_SaveSpawnPoint, type: System.String):UnityEngine.Component
---@overload fun(self: SK_SaveSpawnPoint):any
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: SK_SaveSpawnPoint, includeInactive: System.Boolean):any
---@overload fun(self: SK_SaveSpawnPoint, t: System.Type):UnityEngine.Component
---@overload fun(self: SK_SaveSpawnPoint, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: SK_SaveSpawnPoint):any
...
----@return any
---@overload fun(self: SK_SaveSpawnPoint, type: System.Type):UnityEngine.Component[]
---@overload fun(self: SK_SaveSpawnPoint, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: SK_SaveSpawnPoint)
---@overload fun(self: SK_SaveSpawnPoint)
...
---函数名：GetComponentsInChildren<p>
---函数名：GetComponentsInChildren<p>
---@overload fun(self: SK_SaveSpawnPoint, includeInactive: System.Boolean)
---@overload fun(self: SK_SaveSpawnPoint, includeInactive: System.Boolean)
---@overload fun(self: SK_SaveSpawnPoint)
---@overload fun(self: SK_SaveSpawnPoint)
---@overload fun(self: SK_SaveSpawnPoint, t: System.Type):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: SK_SaveSpawnPoint):System.Boolean
---@overload fun(self: SK_SaveSpawnPoint, methodName: System.String):System.Boolean
...
---函数名：SendMessage<p>
---函数名：SendMessage<p>
---@overload fun(self: SK_SaveSpawnPoint, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_SaveSpawnPoint, methodName: System.String)
---@overload fun(self: SK_SaveSpawnPoint, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_SaveSpawnPoint, methodName: System.String, value: System.Object)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: SK_SaveSpawnPoint, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
---@overload fun(self: SK_SaveSpawnPoint, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: SK_SaveSpawnPoint, methodName: System.String):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: SK_SaveSpawnPoint, routine: System.Collections.IEnumerator)
---@overload fun(self: SK_SaveSpawnPoint, routine: UnityEngine.Coroutine)
---@overload fun(self: SK_SaveSpawnPoint, methodName: System.String)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: SK_SaveSpawnPoint, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: SK_SaveSpawnPoint, unit: Unit):System.Boolean
TargetDetection = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: SK_SaveSpawnPoint, type: System.Type, component: UnityEngine.Component&):System.Boolean
---@overload fun(self: SK_SaveSpawnPoint):System.Boolean
TryGetComponent = function(...) end,

---函数名：AddControlKey<p>
---@param self SK_SaveSpawnPoint
---@param ck ControlKey
...
---@param self SK_SaveSpawnPoint
---@param target Unit
OnPointing = function(self,target) end,
...
---字段名：nextSaveSpawnPoint<p>
---@type Unit
nextSaveSpawnPoint = nil,

---字段名：nextSaveSpawnPointSkill<p>
---@type SK_SaveSpawnPoint
nextSaveSpawnPointSkill = nil,
...
---字段名：spd<p>
---@type GameArchiveData.SpawnPointData
spd = nil,
