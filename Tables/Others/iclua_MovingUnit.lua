...
---@overload fun(self: MovingUnit, force: UnityEngine.Vector2, maxForceNumber?: System.Int32 default:0)
---@overload fun(self: MovingUnit, f: UnityEngine.Vector2, fm?: UnityEngine.ForceMode2D default:Force)
AddForce = function(...) end,

---函数名：AddSkill<p>
---函数名：AddSkill<p>
---@overload fun(self: MovingUnit, type: System.Type):Skill
---@overload fun(self: MovingUnit, sk: Skill):Skill
...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: MovingUnit, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: MovingUnit, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: MovingUnit, methodName: System.String)
---@overload fun(self: MovingUnit, methodName: System.String, parameter: System.Object)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: MovingUnit)
---@overload fun(self: MovingUnit, methodName: System.String)
...
---介绍：只对单位类型为 [物理单位] 或者 [角色单位] 的单位生效<p>
---@overload fun(self: MovingUnit, x?: System.Boolean default:True, y?: System.Boolean default:True)
---@overload fun(self: MovingUnit)
...
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: MovingUnit, type: System.String):UnityEngine.Component
---@overload fun(self: MovingUnit):any
---@overload fun(self: MovingUnit, type: System.Type):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: MovingUnit, t: System.Type):UnityEngine.Component
---@overload fun(self: MovingUnit, includeInactive: System.Boolean):any
---@overload fun(self: MovingUnit, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: MovingUnit):any
...
---@overload fun(self: MovingUnit)
---@overload fun(self: MovingUnit)
---@overload fun(self: MovingUnit, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: MovingUnit, type: System.Type):UnityEngine.Component[]
...
---@overload fun(self: MovingUnit)
---@overload fun(self: MovingUnit)
---@overload fun(self: MovingUnit, includeInactive: System.Boolean)
---@overload fun(self: MovingUnit, includeInactive: System.Boolean)
...
---函数名：GetSkill<p>
---函数名：GetSkill<p>
---@overload fun(self: MovingUnit, ck: ControlKey):Skill
---@overload fun(self: MovingUnit, id: System.String):Skill
---@overload fun(self: MovingUnit, type: System.Type):Skill
GetSkill = function(...) end,

---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: MovingUnit):System.Boolean
---@overload fun(self: MovingUnit, methodName: System.String):System.Boolean
IsInvoking = function(...) end,

---函数名：RemoveSkill<p>
---函数名：RemoveSkill<p>
---@overload fun(self: MovingUnit, type: System.Type)
---@overload fun(self: MovingUnit, sk: Skill)
...
---函数名：SendMessage<p>
---函数名：SendMessage<p>
---@overload fun(self: MovingUnit, methodName: System.String, value: System.Object)
---@overload fun(self: MovingUnit, methodName: System.String)
---@overload fun(self: MovingUnit, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: MovingUnit, methodName: System.String, options: UnityEngine.SendMessageOptions)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: MovingUnit, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
---@overload fun(self: MovingUnit, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: MovingUnit, methodName: System.String):UnityEngine.Coroutine
...
---函数名：StopCoroutine<p>
---@overload fun(self: MovingUnit, methodName: System.String)
---@overload fun(self: MovingUnit, routine: UnityEngine.Coroutine)
---@overload fun(self: MovingUnit, routine: System.Collections.IEnumerator)
StopCoroutine = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: MovingUnit):System.Boolean
---@overload fun(self: MovingUnit, type: System.Type, component: UnityEngine.Component&):System.Boolean
TryGetComponent = function(...) end,

---函数名：UpdatePos<p>
---函数名：UpdatePos<p>
---@overload fun(self: MovingUnit, pivot: UnityEngine.Vector2)
---@overload fun(self: MovingUnit, pivot: UnityEngine.Vector2, size: UnityEngine.Vector2)
UpdatePos = function(...) end,

---函数名：AddArchiveData<p>
---@param self MovingUnit
