...
---@overload fun(self: MovingUnit, force: UnityEngine.Vector2, maxForceNumber?: System.Int32)
---@overload fun(self: MovingUnit, f: UnityEngine.Vector2, fm?: UnityEngine.ForceMode2D)
...
---介绍：只对单位类型为 [物理单位] 或者 [角色单位] 的单位生效<p>
---@overload fun(self: MovingUnit, x?: System.Boolean, y?: System.Boolean)
---@overload fun(self: MovingUnit)
...
---@overload fun(self: MovingUnit)
---@overload fun(self: MovingUnit)
---@overload fun(self: MovingUnit, type: System.Type, results: System.Collections.Generic.List)
---@overload fun(self: MovingUnit, type: System.Type):UnityEngine.Component[]
