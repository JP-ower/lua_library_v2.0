...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: SK_SpriteMask, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_SpriteMask, methodName: System.String)
---@overload fun(self: SK_SpriteMask, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_SpriteMask, methodName: System.String, parameter: System.Object)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: SK_SpriteMask)
---@overload fun(self: SK_SpriteMask, methodName: System.String)
...
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: SK_SpriteMask, type: System.Type):UnityEngine.Component
---@overload fun(self: SK_SpriteMask):any
---@overload fun(self: SK_SpriteMask, type: System.String):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: SK_SpriteMask, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: SK_SpriteMask, t: System.Type):UnityEngine.Component
---@overload fun(self: SK_SpriteMask, includeInactive: System.Boolean):any
---@overload fun(self: SK_SpriteMask):any
...
----@return any
---@overload fun(self: SK_SpriteMask)
---@overload fun(self: SK_SpriteMask, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: SK_SpriteMask, type: System.Type):UnityEngine.Component[]
---@overload fun(self: SK_SpriteMask)
...
---@overload fun(self: SK_SpriteMask)
---@overload fun(self: SK_SpriteMask)
---@overload fun(self: SK_SpriteMask, includeInactive: System.Boolean)
---@overload fun(self: SK_SpriteMask, includeInactive: System.Boolean)
---@overload fun(self: SK_SpriteMask, t: System.Type):UnityEngine.Component[]
---@overload fun(self: SK_SpriteMask, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: SK_SpriteMask):System.Boolean
---@overload fun(self: SK_SpriteMask, methodName: System.String):System.Boolean
...
---函数名：SendMessage<p>
---函数名：SendMessage<p>
---@overload fun(self: SK_SpriteMask, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_SpriteMask, methodName: System.String)
---@overload fun(self: SK_SpriteMask, methodName: System.String, value: System.Object)
---@overload fun(self: SK_SpriteMask, methodName: System.String, options: UnityEngine.SendMessageOptions)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: SK_SpriteMask, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: SK_SpriteMask, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: SK_SpriteMask, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: SK_SpriteMask, routine: UnityEngine.Coroutine)
---@overload fun(self: SK_SpriteMask, methodName: System.String)
---@overload fun(self: SK_SpriteMask, routine: System.Collections.IEnumerator)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: SK_SpriteMask, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: SK_SpriteMask, unit: Unit):System.Boolean
TargetDetection = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: SK_SpriteMask, type: System.Type, component: UnityEngine.Component&):System.Boolean
---@overload fun(self: SK_SpriteMask):System.Boolean
TryGetComponent = function(...) end,

---函数名：AddControlKey<p>
---@param self SK_SpriteMask
---@param ck ControlKey
...
---字段名：backOrderInLayer<p>
---@type System.Int32
backOrderInLayer = nil,

---字段名：backSortingLayer<p>
---@type ObjectSortingLayer
backSortingLayer = nil,
...
---字段名：frontOrderInLayer<p>
---@type System.Int32
frontOrderInLayer = nil,

---字段名：frontSortingLayer<p>
---@type ObjectSortingLayer
frontSortingLayer = nil,
