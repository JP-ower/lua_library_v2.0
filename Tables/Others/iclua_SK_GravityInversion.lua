...
---@overload fun(self: SK_GravityInversion)
---@overload fun(self: SK_GravityInversion)
---@overload fun(self: SK_GravityInversion, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
