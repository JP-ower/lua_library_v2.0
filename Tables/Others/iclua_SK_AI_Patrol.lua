...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: SK_AI_Patrol, methodName: System.String, parameter: System.Object)
---@overload fun(self: SK_AI_Patrol, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_AI_Patrol, methodName: System.String)
---@overload fun(self: SK_AI_Patrol, methodName: System.String, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: SK_AI_Patrol, methodName: System.String)
---@overload fun(self: SK_AI_Patrol)
CancelInvoke = function(...) end,

---函数名：GetComponent<p>
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: SK_AI_Patrol, type: System.Type):UnityEngine.Component
---@overload fun(self: SK_AI_Patrol, type: System.String):UnityEngine.Component
---@overload fun(self: SK_AI_Patrol):any
...
---函数名：GetComponentInChildren<p>
---@overload fun(self: SK_AI_Patrol):any
---@overload fun(self: SK_AI_Patrol, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: SK_AI_Patrol, t: System.Type):UnityEngine.Component
---@overload fun(self: SK_AI_Patrol, includeInactive: System.Boolean):any
...
----@return any
---函数名：GetComponents<p>
---@overload fun(self: SK_AI_Patrol, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: SK_AI_Patrol)
---@overload fun(self: SK_AI_Patrol)
---@overload fun(self: SK_AI_Patrol, type: System.Type):UnityEngine.Component[]
...
---@overload fun(self: SK_AI_Patrol)
---@overload fun(self: SK_AI_Patrol)
---@overload fun(self: SK_AI_Patrol, includeInactive: System.Boolean)
---@overload fun(self: SK_AI_Patrol, includeInactive: System.Boolean)
---@overload fun(self: SK_AI_Patrol, t: System.Type):UnityEngine.Component[]
---@overload fun(self: SK_AI_Patrol, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: SK_AI_Patrol):System.Boolean
---@overload fun(self: SK_AI_Patrol, methodName: System.String):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: SK_AI_Patrol, methodName: System.String)
---@overload fun(self: SK_AI_Patrol, methodName: System.String, value: System.Object)
---@overload fun(self: SK_AI_Patrol, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_AI_Patrol, methodName: System.String, options: UnityEngine.SendMessageOptions)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: SK_AI_Patrol, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: SK_AI_Patrol, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: SK_AI_Patrol, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: SK_AI_Patrol, routine: System.Collections.IEnumerator)
---@overload fun(self: SK_AI_Patrol, routine: UnityEngine.Coroutine)
---@overload fun(self: SK_AI_Patrol, methodName: System.String)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: SK_AI_Patrol, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: SK_AI_Patrol, unit: Unit):System.Boolean
TargetDetection = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: SK_AI_Patrol):System.Boolean
---@overload fun(self: SK_AI_Patrol, type: System.Type, component: UnityEngine.Component&):System.Boolean
TryGetComponent = function(...) end,

---函数名：AIStart<p>
---@param self SK_AI_Patrol
...
---字段名：autoSetCheckGround<p>
---@type System.Boolean
autoSetCheckGround = nil,
...
---字段名：cgd<p>
---@type SK_AI_Patrol.CheckGroundDir
cgd = nil,
...
---字段名：checkGroundAngleOffset<p>
---@type System.Single
checkGroundAngleOffset = nil,
...
---字段名：groundCheckDis<p>
---@type System.Single
groundCheckDis = nil,

---字段名：groundTargetType<p>
---@type System.String
groundTargetType = nil,

---字段名：get_hideFlags<p>
---@type UnityEngine.HideFlags
hideFlags = nil,

---字段名：hinderCheckDis<p>
---@type System.Single
hinderCheckDis = nil,

---字段名：hinderTargetType<p>
---@type System.String
hinderTargetType = nil,
