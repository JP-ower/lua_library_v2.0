...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: SK_ResetJumpTimes, methodName: System.String, parameter: System.Object)
---@overload fun(self: SK_ResetJumpTimes, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_ResetJumpTimes, methodName: System.String)
---@overload fun(self: SK_ResetJumpTimes, methodName: System.String, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: SK_ResetJumpTimes, methodName: System.String)
---@overload fun(self: SK_ResetJumpTimes)
CancelInvoke = function(...) end,

---函数名：GetComponent<p>
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: SK_ResetJumpTimes, type: System.Type):UnityEngine.Component
---@overload fun(self: SK_ResetJumpTimes):any
---@overload fun(self: SK_ResetJumpTimes, type: System.String):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: SK_ResetJumpTimes, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: SK_ResetJumpTimes, t: System.Type):UnityEngine.Component
---@overload fun(self: SK_ResetJumpTimes, includeInactive: System.Boolean):any
---@overload fun(self: SK_ResetJumpTimes):any
...
---@overload fun(self: SK_ResetJumpTimes)
---@overload fun(self: SK_ResetJumpTimes)
---@overload fun(self: SK_ResetJumpTimes, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: SK_ResetJumpTimes, type: System.Type):UnityEngine.Component[]
...
---@overload fun(self: SK_ResetJumpTimes)
---@overload fun(self: SK_ResetJumpTimes)
---@overload fun(self: SK_ResetJumpTimes, includeInactive: System.Boolean)
---@overload fun(self: SK_ResetJumpTimes, includeInactive: System.Boolean)
---@overload fun(self: SK_ResetJumpTimes, t: System.Type):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: SK_ResetJumpTimes):System.Boolean
---@overload fun(self: SK_ResetJumpTimes, methodName: System.String):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: SK_ResetJumpTimes, methodName: System.String)
---@overload fun(self: SK_ResetJumpTimes, methodName: System.String, value: System.Object)
---@overload fun(self: SK_ResetJumpTimes, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_ResetJumpTimes, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: SK_ResetJumpTimes, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
---@overload fun(self: SK_ResetJumpTimes, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: SK_ResetJumpTimes, methodName: System.String, value: System.Object):UnityEngine.Coroutine
...
---函数名：StopCoroutine<p>
---@overload fun(self: SK_ResetJumpTimes, methodName: System.String)
---@overload fun(self: SK_ResetJumpTimes, routine: UnityEngine.Coroutine)
---@overload fun(self: SK_ResetJumpTimes, routine: System.Collections.IEnumerator)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: SK_ResetJumpTimes, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: SK_ResetJumpTimes, unit: Unit):System.Boolean
TargetDetection = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: SK_ResetJumpTimes, type: System.Type, component: UnityEngine.Component&):System.Boolean
---@overload fun(self: SK_ResetJumpTimes):System.Boolean
TryGetComponent = function(...) end,

---函数名：AddControlKey<p>
---@param self SK_ResetJumpTimes
---@param ck ControlKey
