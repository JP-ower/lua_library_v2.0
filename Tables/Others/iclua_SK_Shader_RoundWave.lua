...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: SK_Shader_RoundWave, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_Shader_RoundWave, methodName: System.String, parameter: System.Object)
---@overload fun(self: SK_Shader_RoundWave, methodName: System.String)
---@overload fun(self: SK_Shader_RoundWave, methodName: System.String, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: SK_Shader_RoundWave)
---@overload fun(self: SK_Shader_RoundWave, methodName: System.String)
...
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: SK_Shader_RoundWave, type: System.Type):UnityEngine.Component
---@overload fun(self: SK_Shader_RoundWave):any
---@overload fun(self: SK_Shader_RoundWave, type: System.String):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: SK_Shader_RoundWave, t: System.Type):UnityEngine.Component
---@overload fun(self: SK_Shader_RoundWave):any
---@overload fun(self: SK_Shader_RoundWave, includeInactive: System.Boolean):any
---@overload fun(self: SK_Shader_RoundWave, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
...
----@return any
---@overload fun(self: SK_Shader_RoundWave, type: System.Type):UnityEngine.Component[]
---@overload fun(self: SK_Shader_RoundWave, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: SK_Shader_RoundWave)
---@overload fun(self: SK_Shader_RoundWave)
...
---@overload fun(self: SK_Shader_RoundWave, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
---@overload fun(self: SK_Shader_RoundWave, t: System.Type):UnityEngine.Component[]
---@overload fun(self: SK_Shader_RoundWave, includeInactive: System.Boolean)
---@overload fun(self: SK_Shader_RoundWave, includeInactive: System.Boolean)
---@overload fun(self: SK_Shader_RoundWave)
---@overload fun(self: SK_Shader_RoundWave)
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: SK_Shader_RoundWave):System.Boolean
---@overload fun(self: SK_Shader_RoundWave, methodName: System.String):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: SK_Shader_RoundWave, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_Shader_RoundWave, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_Shader_RoundWave, methodName: System.String)
---@overload fun(self: SK_Shader_RoundWave, methodName: System.String, value: System.Object)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: SK_Shader_RoundWave, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: SK_Shader_RoundWave, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: SK_Shader_RoundWave, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: SK_Shader_RoundWave, routine: System.Collections.IEnumerator)
---@overload fun(self: SK_Shader_RoundWave, routine: UnityEngine.Coroutine)
---@overload fun(self: SK_Shader_RoundWave, methodName: System.String)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: SK_Shader_RoundWave, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: SK_Shader_RoundWave, unit: Unit):System.Boolean
TargetDetection = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: SK_Shader_RoundWave, type: System.Type, component: UnityEngine.Component&):System.Boolean
---@overload fun(self: SK_Shader_RoundWave):System.Boolean
TryGetComponent = function(...) end,

---函数名：AddControlKey<p>
---@param self SK_Shader_RoundWave
---@param ck ControlKey
...
---字段名：ROUNDWAVEUV_ON<p>
---@type System.Boolean
ROUNDWAVEUV_ON = nil,

---字段名：_RoundWaveSpeed<p>
---@type System.Single
_RoundWaveSpeed = nil,

---字段名：_RoundWaveStrength<p>
---@type System.Single
_RoundWaveStrength = nil,
