...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: RangeInductiveSkill, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: RangeInductiveSkill, methodName: System.String)
---@overload fun(self: RangeInductiveSkill, methodName: System.String, parameter: System.Object)
---@overload fun(self: RangeInductiveSkill, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: RangeInductiveSkill)
---@overload fun(self: RangeInductiveSkill, methodName: System.String)
...
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: RangeInductiveSkill):any
---@overload fun(self: RangeInductiveSkill, type: System.String):UnityEngine.Component
---@overload fun(self: RangeInductiveSkill, type: System.Type):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: RangeInductiveSkill, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: RangeInductiveSkill, t: System.Type):UnityEngine.Component
---@overload fun(self: RangeInductiveSkill, includeInactive: System.Boolean):any
---@overload fun(self: RangeInductiveSkill):any
...
---@overload fun(self: RangeInductiveSkill)
---@overload fun(self: RangeInductiveSkill)
---@overload fun(self: RangeInductiveSkill, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
...
---@overload fun(self: RangeInductiveSkill)
---@overload fun(self: RangeInductiveSkill)
---@overload fun(self: RangeInductiveSkill, includeInactive: System.Boolean)
---@overload fun(self: RangeInductiveSkill, includeInactive: System.Boolean)
---@overload fun(self: RangeInductiveSkill, t: System.Type):UnityEngine.Component[]
---@overload fun(self: RangeInductiveSkill, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: RangeInductiveSkill, methodName: System.String):System.Boolean
---@overload fun(self: RangeInductiveSkill):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: RangeInductiveSkill, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: RangeInductiveSkill, methodName: System.String, value: System.Object)
---@overload fun(self: RangeInductiveSkill, methodName: System.String)
---@overload fun(self: RangeInductiveSkill, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: RangeInductiveSkill, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: RangeInductiveSkill, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: RangeInductiveSkill, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
...
---函数名：StopCoroutine<p>
---@overload fun(self: RangeInductiveSkill, methodName: System.String)
---@overload fun(self: RangeInductiveSkill, routine: UnityEngine.Coroutine)
---@overload fun(self: RangeInductiveSkill, routine: System.Collections.IEnumerator)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: RangeInductiveSkill, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: RangeInductiveSkill, unit: Unit):System.Boolean
TargetDetection = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: RangeInductiveSkill, type: System.Type, component: UnityEngine.Component&):System.Boolean
---@overload fun(self: RangeInductiveSkill):System.Boolean
TryGetComponent = function(...) end,

---函数名：AddControlKey<p>
---@param self RangeInductiveSkill
---@param ck ControlKey
...
SetRange = function(self,range) end,
