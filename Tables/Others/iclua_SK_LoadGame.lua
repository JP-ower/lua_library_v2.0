...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: SK_LoadGame, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_LoadGame, methodName: System.String)
---@overload fun(self: SK_LoadGame, methodName: System.String, parameter: System.Object)
---@overload fun(self: SK_LoadGame, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: SK_LoadGame)
---@overload fun(self: SK_LoadGame, methodName: System.String)
...
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: SK_LoadGame, type: System.String):UnityEngine.Component
---@overload fun(self: SK_LoadGame):any
---@overload fun(self: SK_LoadGame, type: System.Type):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: SK_LoadGame, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: SK_LoadGame, t: System.Type):UnityEngine.Component
---@overload fun(self: SK_LoadGame, includeInactive: System.Boolean):any
---@overload fun(self: SK_LoadGame):any
...
----@return any
---@overload fun(self: SK_LoadGame, type: System.Type):UnityEngine.Component[]
---@overload fun(self: SK_LoadGame, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: SK_LoadGame)
---@overload fun(self: SK_LoadGame)
...
---@overload fun(self: SK_LoadGame)
---@overload fun(self: SK_LoadGame)
---@overload fun(self: SK_LoadGame, includeInactive: System.Boolean)
---@overload fun(self: SK_LoadGame, includeInactive: System.Boolean)
---@overload fun(self: SK_LoadGame, t: System.Type):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: SK_LoadGame, methodName: System.String):System.Boolean
---@overload fun(self: SK_LoadGame):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: SK_LoadGame, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_LoadGame, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_LoadGame, methodName: System.String)
---@overload fun(self: SK_LoadGame, methodName: System.String, value: System.Object)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: SK_LoadGame, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
---@overload fun(self: SK_LoadGame, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: SK_LoadGame, methodName: System.String, value: System.Object):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: SK_LoadGame, routine: UnityEngine.Coroutine)
---@overload fun(self: SK_LoadGame, methodName: System.String)
---@overload fun(self: SK_LoadGame, routine: System.Collections.IEnumerator)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: SK_LoadGame, unit: Unit):System.Boolean
---@overload fun(self: SK_LoadGame, unit: Unit, affectTargetType: System.String):System.Boolean
TargetDetection = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: SK_LoadGame):System.Boolean
---@overload fun(self: SK_LoadGame, type: System.Type, component: UnityEngine.Component&):System.Boolean
TryGetComponent = function(...) end,

---函数名：AddControlKey<p>
---@param self SK_LoadGame
---@param ck ControlKey
...
---@param self SK_LoadGame
---@return System.Boolean
GetLockStatus = function(self) end,
...
---@param self SK_LoadGame
---@param unit Unit
OnPointing = function(self,unit) end,
...
---@param self SK_LoadGame
---@param be System.Boolean
SetLockStatus = function(self,be) end,

---函数名：SetServerGameInfoData<p>
---@param self SK_LoadGame
---@param gid GameInfoData
SetServerGameInfoData = function(self,gid) end,
...
---字段名：cd<p>
---@type GameArchiveData.ClearanceData
cd = nil,
