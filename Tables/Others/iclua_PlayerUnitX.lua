...
---@overload fun(self: PlayerUnitX, force: UnityEngine.Vector2, maxForceNumber?: System.Int32)
---@overload fun(self: PlayerUnitX, f: UnityEngine.Vector2, fm?: UnityEngine.ForceMode2D)
...
---函数名：ClearForce<p>
---@overload fun(self: PlayerUnitX)
---@overload fun(self: PlayerUnitX, x?: System.Boolean, y?: System.Boolean)
...
---@overload fun(self: PlayerUnitX)
---@overload fun(self: PlayerUnitX)
---@overload fun(self: PlayerUnitX, type: System.Type, results: System.Collections.Generic.List)
---@overload fun(self: PlayerUnitX, type: System.Type):UnityEngine.Component[]
