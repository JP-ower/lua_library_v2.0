...
---@overload fun(self: PlayerUnitX, force: UnityEngine.Vector2, maxForceNumber?: System.Int32 default:0)
---@overload fun(self: PlayerUnitX, f: UnityEngine.Vector2, fm?: UnityEngine.ForceMode2D default:Force)
AddForce = function(...) end,

---函数名：AddSkill<p>
---函数名：AddSkill<p>
---@overload fun(self: PlayerUnitX, type: System.Type):Skill
---@overload fun(self: PlayerUnitX, sk: Skill):Skill
...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: PlayerUnitX, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: PlayerUnitX, methodName: System.String, parameter: System.Object)
---@overload fun(self: PlayerUnitX, methodName: System.String)
---@overload fun(self: PlayerUnitX, methodName: System.String, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: PlayerUnitX)
---@overload fun(self: PlayerUnitX, methodName: System.String)
...
---函数名：ClearForce<p>
---@overload fun(self: PlayerUnitX)
---@overload fun(self: PlayerUnitX, x?: System.Boolean default:True, y?: System.Boolean default:True)
ClearForce = function(...) end,

---函数名：GetComponent<p>
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: PlayerUnitX, type: System.Type):UnityEngine.Component
---@overload fun(self: PlayerUnitX):any
---@overload fun(self: PlayerUnitX, type: System.String):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: PlayerUnitX, t: System.Type):UnityEngine.Component
---@overload fun(self: PlayerUnitX, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: PlayerUnitX, includeInactive: System.Boolean):any
---@overload fun(self: PlayerUnitX):any
...
---@overload fun(self: PlayerUnitX)
---@overload fun(self: PlayerUnitX)
---@overload fun(self: PlayerUnitX, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: PlayerUnitX, type: System.Type):UnityEngine.Component[]
...
---函数名：GetComponentsInChildren<p>
---@overload fun(self: PlayerUnitX, t: System.Type):UnityEngine.Component[]
---@overload fun(self: PlayerUnitX, includeInactive: System.Boolean)
---@overload fun(self: PlayerUnitX, includeInactive: System.Boolean)
---@overload fun(self: PlayerUnitX, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
---@overload fun(self: PlayerUnitX)
---@overload fun(self: PlayerUnitX)
...
---函数名：GetSkill<p>
---@overload fun(self: PlayerUnitX, type: System.Type):Skill
---@overload fun(self: PlayerUnitX, ck: ControlKey):Skill
---@overload fun(self: PlayerUnitX, id: System.String):Skill
GetSkill = function(...) end,

---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: PlayerUnitX, methodName: System.String):System.Boolean
---@overload fun(self: PlayerUnitX):System.Boolean
IsInvoking = function(...) end,

---函数名：RemoveSkill<p>
---函数名：RemoveSkill<p>
---@overload fun(self: PlayerUnitX, type: System.Type)
---@overload fun(self: PlayerUnitX, sk: Skill)
RemoveSkill = function(...) end,
...
---@overload fun(self: PlayerUnitX, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: PlayerUnitX, methodName: System.String)
---@overload fun(self: PlayerUnitX, methodName: System.String, value: System.Object)
---@overload fun(self: PlayerUnitX, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: PlayerUnitX, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: PlayerUnitX, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: PlayerUnitX, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: PlayerUnitX, routine: System.Collections.IEnumerator)
---@overload fun(self: PlayerUnitX, routine: UnityEngine.Coroutine)
---@overload fun(self: PlayerUnitX, methodName: System.String)
StopCoroutine = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: PlayerUnitX, type: System.Type, component: UnityEngine.Component&):System.Boolean
---@overload fun(self: PlayerUnitX):System.Boolean
TryGetComponent = function(...) end,

---函数名：UpdatePos<p>
---函数名：UpdatePos<p>
---@overload fun(self: PlayerUnitX, pivot: UnityEngine.Vector2)
---@overload fun(self: PlayerUnitX, pivot: UnityEngine.Vector2, size: UnityEngine.Vector2)
UpdatePos = function(...) end,

---函数名：AddArchiveData<p>
---@param self PlayerUnitX
...
---函数名：ClearVelocity<p>
---@param self PlayerUnitX
ClearVelocity = function(self) end,

---函数名：ClearVelocityX<p>
---@param self PlayerUnitX
ClearVelocityX = function(self) end,

---函数名：ClearVelocityY<p>
---@param self PlayerUnitX
ClearVelocityY = function(self) end,
...
---字段名：ci<p>
---@type RoleUnit.CollideInfo
ci = nil,

---字段名：collideTransform<p>
---@type UnityEngine.Transform[]
collideTransform = nil,
...
---字段名：collisionUnitList<p>
---@type System.Collections.Generic.List`1[[Unit, Assembly-CSharp, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]]
collisionUnitList = nil,
