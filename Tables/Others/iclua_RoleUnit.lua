...
---@overload fun(self: RoleUnit, force: UnityEngine.Vector2, maxForceNumber?: System.Int32 default:0)
---@overload fun(self: RoleUnit, f: UnityEngine.Vector2, fm?: UnityEngine.ForceMode2D default:Force)
AddForce = function(...) end,

---函数名：AddSkill<p>
---函数名：AddSkill<p>
---@overload fun(self: RoleUnit, type: System.Type):Skill
---@overload fun(self: RoleUnit, sk: Skill):Skill
...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: RoleUnit, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: RoleUnit, methodName: System.String, parameter: System.Object)
---@overload fun(self: RoleUnit, methodName: System.String)
---@overload fun(self: RoleUnit, methodName: System.String, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: RoleUnit)
---@overload fun(self: RoleUnit, methodName: System.String)
...
---函数名：ClearForce<p>
---@overload fun(self: RoleUnit)
---@overload fun(self: RoleUnit, x?: System.Boolean default:True, y?: System.Boolean default:True)
ClearForce = function(...) end,

---函数名：GetComponent<p>
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: RoleUnit, type: System.String):UnityEngine.Component
---@overload fun(self: RoleUnit):any
---@overload fun(self: RoleUnit, type: System.Type):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---@overload fun(self: RoleUnit):any
---@overload fun(self: RoleUnit, t: System.Type):UnityEngine.Component
---@overload fun(self: RoleUnit, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: RoleUnit, includeInactive: System.Boolean):any
...
----@return any
---函数名：GetComponents<p>
---@overload fun(self: RoleUnit, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: RoleUnit)
---@overload fun(self: RoleUnit)
---@overload fun(self: RoleUnit, type: System.Type):UnityEngine.Component[]
...
---函数名：GetComponentsInChildren<p>
---@overload fun(self: RoleUnit, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
---@overload fun(self: RoleUnit, includeInactive: System.Boolean)
---@overload fun(self: RoleUnit, includeInactive: System.Boolean)
---@overload fun(self: RoleUnit)
---@overload fun(self: RoleUnit, t: System.Type):UnityEngine.Component[]
---@overload fun(self: RoleUnit)
...
---函数名：GetSkill<p>
---函数名：GetSkill<p>
---@overload fun(self: RoleUnit, ck: ControlKey):Skill
---@overload fun(self: RoleUnit, type: System.Type):Skill
---@overload fun(self: RoleUnit, id: System.String):Skill
GetSkill = function(...) end,

---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: RoleUnit, methodName: System.String):System.Boolean
---@overload fun(self: RoleUnit):System.Boolean
IsInvoking = function(...) end,

---函数名：RemoveSkill<p>
---函数名：RemoveSkill<p>
---@overload fun(self: RoleUnit, type: System.Type)
---@overload fun(self: RoleUnit, sk: Skill)
...
---@overload fun(self: RoleUnit, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: RoleUnit, methodName: System.String)
---@overload fun(self: RoleUnit, methodName: System.String, value: System.Object)
---@overload fun(self: RoleUnit, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: RoleUnit, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: RoleUnit, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: RoleUnit, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: RoleUnit, routine: System.Collections.IEnumerator)
---@overload fun(self: RoleUnit, routine: UnityEngine.Coroutine)
---@overload fun(self: RoleUnit, methodName: System.String)
StopCoroutine = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: RoleUnit, type: System.Type, component: UnityEngine.Component&):System.Boolean
---@overload fun(self: RoleUnit):System.Boolean
TryGetComponent = function(...) end,

---函数名：UpdatePos<p>
---函数名：UpdatePos<p>
---@overload fun(self: RoleUnit, pivot: UnityEngine.Vector2)
---@overload fun(self: RoleUnit, pivot: UnityEngine.Vector2, size: UnityEngine.Vector2)
