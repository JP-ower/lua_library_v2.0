...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: SK_Shader_Twist, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_Shader_Twist, methodName: System.String, parameter: System.Object)
---@overload fun(self: SK_Shader_Twist, methodName: System.String)
---@overload fun(self: SK_Shader_Twist, methodName: System.String, options: UnityEngine.SendMessageOptions)
...
---@overload fun(self: SK_Shader_Twist):any
---@overload fun(self: SK_Shader_Twist, type: System.String):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: SK_Shader_Twist, t: System.Type):UnityEngine.Component
---@overload fun(self: SK_Shader_Twist):any
---@overload fun(self: SK_Shader_Twist, includeInactive: System.Boolean):any
---@overload fun(self: SK_Shader_Twist, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
...
---@overload fun(self: SK_Shader_Twist, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
---@overload fun(self: SK_Shader_Twist, t: System.Type):UnityEngine.Component[]
---@overload fun(self: SK_Shader_Twist, includeInactive: System.Boolean)
---@overload fun(self: SK_Shader_Twist, includeInactive: System.Boolean)
---@overload fun(self: SK_Shader_Twist)
---@overload fun(self: SK_Shader_Twist)
...
---@overload fun(self: SK_Shader_Twist, methodName: System.String):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: SK_Shader_Twist, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_Shader_Twist, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_Shader_Twist, methodName: System.String)
---@overload fun(self: SK_Shader_Twist, methodName: System.String, value: System.Object)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: SK_Shader_Twist, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: SK_Shader_Twist, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: SK_Shader_Twist, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: SK_Shader_Twist, routine: System.Collections.IEnumerator)
---@overload fun(self: SK_Shader_Twist, routine: UnityEngine.Coroutine)
---@overload fun(self: SK_Shader_Twist, methodName: System.String)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: SK_Shader_Twist, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: SK_Shader_Twist, unit: Unit):System.Boolean
