...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: SK_PassInspection, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_PassInspection, methodName: System.String)
---@overload fun(self: SK_PassInspection, methodName: System.String, parameter: System.Object)
---@overload fun(self: SK_PassInspection, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
...
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: SK_PassInspection):any
---@overload fun(self: SK_PassInspection, type: System.String):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: SK_PassInspection, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: SK_PassInspection, t: System.Type):UnityEngine.Component
---@overload fun(self: SK_PassInspection, includeInactive: System.Boolean):any
---@overload fun(self: SK_PassInspection):any
...
---@overload fun(self: SK_PassInspection)
---@overload fun(self: SK_PassInspection)
---@overload fun(self: SK_PassInspection, includeInactive: System.Boolean)
---@overload fun(self: SK_PassInspection, includeInactive: System.Boolean)
---@overload fun(self: SK_PassInspection, t: System.Type):UnityEngine.Component[]
---@overload fun(self: SK_PassInspection, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: SK_PassInspection, methodName: System.String):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: SK_PassInspection, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_PassInspection, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_PassInspection, methodName: System.String)
---@overload fun(self: SK_PassInspection, methodName: System.String, value: System.Object)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: SK_PassInspection, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: SK_PassInspection, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: SK_PassInspection, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
...
---函数名：StopCoroutine<p>
---@overload fun(self: SK_PassInspection, methodName: System.String)
---@overload fun(self: SK_PassInspection, routine: System.Collections.IEnumerator)
---@overload fun(self: SK_PassInspection, routine: UnityEngine.Coroutine)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: SK_PassInspection, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: SK_PassInspection, unit: Unit):System.Boolean
...
---@param self SK_PassInspection
---@param unit Unit
AddTargetUnit = function(self,unit) end,
...
---字段名：starNeedCount_Level<p>
---@type System.Int32
starNeedCount_Level = nil,
