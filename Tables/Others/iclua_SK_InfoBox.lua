...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: SK_InfoBox, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_InfoBox, methodName: System.String, parameter: System.Object)
---@overload fun(self: SK_InfoBox, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_InfoBox, methodName: System.String)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: SK_InfoBox, methodName: System.String)
---@overload fun(self: SK_InfoBox)
CancelInvoke = function(...) end,

---函数名：GetComponent<p>
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: SK_InfoBox, type: System.String):UnityEngine.Component
---@overload fun(self: SK_InfoBox):any
---@overload fun(self: SK_InfoBox, type: System.Type):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---@overload fun(self: SK_InfoBox):any
---@overload fun(self: SK_InfoBox, includeInactive: System.Boolean):any
---@overload fun(self: SK_InfoBox, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: SK_InfoBox, t: System.Type):UnityEngine.Component
...
----@return any
---@overload fun(self: SK_InfoBox, type: System.Type):UnityEngine.Component[]
---@overload fun(self: SK_InfoBox, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: SK_InfoBox)
---@overload fun(self: SK_InfoBox)
...
---函数名：GetComponentsInChildren<p>
---函数名：GetComponentsInChildren<p>
---@overload fun(self: SK_InfoBox, includeInactive: System.Boolean)
---@overload fun(self: SK_InfoBox, includeInactive: System.Boolean)
---@overload fun(self: SK_InfoBox)
---@overload fun(self: SK_InfoBox)
---@overload fun(self: SK_InfoBox, t: System.Type):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: SK_InfoBox, methodName: System.String):System.Boolean
---@overload fun(self: SK_InfoBox):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: SK_InfoBox, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_InfoBox, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_InfoBox, methodName: System.String)
---@overload fun(self: SK_InfoBox, methodName: System.String, value: System.Object)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: SK_InfoBox, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: SK_InfoBox, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: SK_InfoBox, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
...
---函数名：StopCoroutine<p>
---@overload fun(self: SK_InfoBox, methodName: System.String)
---@overload fun(self: SK_InfoBox, routine: System.Collections.IEnumerator)
---@overload fun(self: SK_InfoBox, routine: UnityEngine.Coroutine)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: SK_InfoBox, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: SK_InfoBox, unit: Unit):System.Boolean
TargetDetection = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: SK_InfoBox):System.Boolean
---@overload fun(self: SK_InfoBox, type: System.Type, component: UnityEngine.Component&):System.Boolean
TryGetComponent = function(...) end,

---函数名：AddControlKey<p>
---@param self SK_InfoBox
---@param ck ControlKey
