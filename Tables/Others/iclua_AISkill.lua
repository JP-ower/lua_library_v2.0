...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: AISkill, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: AISkill, methodName: System.String)
---@overload fun(self: AISkill, methodName: System.String, parameter: System.Object)
---@overload fun(self: AISkill, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
...
---@overload fun(self: AISkill):any
---@overload fun(self: AISkill, type: System.String):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: AISkill, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: AISkill, t: System.Type):UnityEngine.Component
---@overload fun(self: AISkill, includeInactive: System.Boolean):any
---@overload fun(self: AISkill):any
...
---@overload fun(self: AISkill, t: System.Type):UnityEngine.Component[]
---@overload fun(self: AISkill)
---@overload fun(self: AISkill, includeInactive: System.Boolean)
---@overload fun(self: AISkill, includeInactive: System.Boolean)
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: AISkill, methodName: System.String):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: AISkill, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: AISkill, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: AISkill, methodName: System.String)
---@overload fun(self: AISkill, methodName: System.String, value: System.Object)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: AISkill, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: AISkill, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: AISkill, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: AISkill, routine: System.Collections.IEnumerator)
---@overload fun(self: AISkill, routine: UnityEngine.Coroutine)
---@overload fun(self: AISkill, methodName: System.String)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: AISkill, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: AISkill, unit: Unit):System.Boolean
