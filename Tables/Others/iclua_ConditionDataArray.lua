...
---函数名：GetRootFDA<p>
---函数名：GetRootFDA<p>
---@overload fun(self: ConditionDataArray, condition: FunctionDataArray.D_GetRootFDACondition):FunctionDataArray
---@overload fun(self: ConditionDataArray):FunctionDataArray
GetRootFDA = function(...) end,
