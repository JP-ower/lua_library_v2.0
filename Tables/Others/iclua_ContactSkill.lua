...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: ContactSkill, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: ContactSkill, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: ContactSkill, methodName: System.String)
---@overload fun(self: ContactSkill, methodName: System.String, parameter: System.Object)
...
---@overload fun(self: ContactSkill, type: System.String):UnityEngine.Component
---@overload fun(self: ContactSkill):any
...
---函数名：GetComponentInChildren<p>
---@overload fun(self: ContactSkill):any
---@overload fun(self: ContactSkill, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: ContactSkill, t: System.Type):UnityEngine.Component
---@overload fun(self: ContactSkill, includeInactive: System.Boolean):any
...
---@overload fun(self: ContactSkill)
---@overload fun(self: ContactSkill)
---@overload fun(self: ContactSkill, includeInactive: System.Boolean)
---@overload fun(self: ContactSkill, includeInactive: System.Boolean)
---@overload fun(self: ContactSkill, t: System.Type):UnityEngine.Component[]
---@overload fun(self: ContactSkill, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: ContactSkill, methodName: System.String):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: ContactSkill, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: ContactSkill, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: ContactSkill, methodName: System.String)
---@overload fun(self: ContactSkill, methodName: System.String, value: System.Object)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: ContactSkill, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
---@overload fun(self: ContactSkill, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: ContactSkill, methodName: System.String, value: System.Object):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: ContactSkill, routine: System.Collections.IEnumerator)
---@overload fun(self: ContactSkill, routine: UnityEngine.Coroutine)
---@overload fun(self: ContactSkill, methodName: System.String)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: ContactSkill, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: ContactSkill, unit: Unit):System.Boolean
