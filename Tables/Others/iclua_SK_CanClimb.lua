...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: SK_CanClimb, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_CanClimb, methodName: System.String)
---@overload fun(self: SK_CanClimb, methodName: System.String, parameter: System.Object)
---@overload fun(self: SK_CanClimb, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
...
---@overload fun(self: SK_CanClimb, type: System.String):UnityEngine.Component
---@overload fun(self: SK_CanClimb):any
...
---函数名：GetComponentInChildren<p>
---@overload fun(self: SK_CanClimb):any
---@overload fun(self: SK_CanClimb, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: SK_CanClimb, t: System.Type):UnityEngine.Component
---@overload fun(self: SK_CanClimb, includeInactive: System.Boolean):any
...
---@overload fun(self: SK_CanClimb)
---@overload fun(self: SK_CanClimb)
---@overload fun(self: SK_CanClimb, includeInactive: System.Boolean)
---@overload fun(self: SK_CanClimb, includeInactive: System.Boolean)
---@overload fun(self: SK_CanClimb, t: System.Type):UnityEngine.Component[]
---@overload fun(self: SK_CanClimb, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: SK_CanClimb, methodName: System.String):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: SK_CanClimb, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_CanClimb, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_CanClimb, methodName: System.String)
---@overload fun(self: SK_CanClimb, methodName: System.String, value: System.Object)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: SK_CanClimb, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
---@overload fun(self: SK_CanClimb, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: SK_CanClimb, methodName: System.String, value: System.Object):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: SK_CanClimb, routine: System.Collections.IEnumerator)
---@overload fun(self: SK_CanClimb, routine: UnityEngine.Coroutine)
---@overload fun(self: SK_CanClimb, methodName: System.String)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: SK_CanClimb, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: SK_CanClimb, unit: Unit):System.Boolean
