...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: SK_Split, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_Split, methodName: System.String)
---@overload fun(self: SK_Split, methodName: System.String, parameter: System.Object)
---@overload fun(self: SK_Split, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: SK_Split)
---@overload fun(self: SK_Split, methodName: System.String)
...
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: SK_Split, type: System.Type):UnityEngine.Component
---@overload fun(self: SK_Split):any
---@overload fun(self: SK_Split, type: System.String):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: SK_Split, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: SK_Split, t: System.Type):UnityEngine.Component
---@overload fun(self: SK_Split, includeInactive: System.Boolean):any
---@overload fun(self: SK_Split):any
...
----@return any
---@overload fun(self: SK_Split)
---@overload fun(self: SK_Split, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: SK_Split, type: System.Type):UnityEngine.Component[]
---@overload fun(self: SK_Split)
...
---@overload fun(self: SK_Split)
---@overload fun(self: SK_Split)
---@overload fun(self: SK_Split, includeInactive: System.Boolean)
---@overload fun(self: SK_Split, includeInactive: System.Boolean)
---@overload fun(self: SK_Split, t: System.Type):UnityEngine.Component[]
---@overload fun(self: SK_Split, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: SK_Split, methodName: System.String):System.Boolean
---@overload fun(self: SK_Split):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: SK_Split, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_Split, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_Split, methodName: System.String)
---@overload fun(self: SK_Split, methodName: System.String, value: System.Object)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: SK_Split, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: SK_Split, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: SK_Split, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: SK_Split, routine: System.Collections.IEnumerator)
---@overload fun(self: SK_Split, methodName: System.String)
---@overload fun(self: SK_Split, routine: UnityEngine.Coroutine)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: SK_Split, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: SK_Split, unit: Unit):System.Boolean
TargetDetection = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: SK_Split):System.Boolean
---@overload fun(self: SK_Split, type: System.Type, component: UnityEngine.Component&):System.Boolean
