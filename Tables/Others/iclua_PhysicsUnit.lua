...
---@overload fun(self: PhysicsUnit, f: UnityEngine.Vector2, fm?: UnityEngine.ForceMode2D default:Force)
---@overload fun(self: PhysicsUnit, f: UnityEngine.Vector2, fm?: UnityEngine.ForceMode2D default:Force)
AddForce = function(...) end,

---函数名：AddSkill<p>
---函数名：AddSkill<p>
---@overload fun(self: PhysicsUnit, type: System.Type):Skill
---@overload fun(self: PhysicsUnit, sk: Skill):Skill
...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: PhysicsUnit, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: PhysicsUnit, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: PhysicsUnit, methodName: System.String)
---@overload fun(self: PhysicsUnit, methodName: System.String, parameter: System.Object)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: PhysicsUnit, methodName: System.String)
---@overload fun(self: PhysicsUnit)
...
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: PhysicsUnit, type: System.String):UnityEngine.Component
---@overload fun(self: PhysicsUnit, type: System.Type):UnityEngine.Component
---@overload fun(self: PhysicsUnit):any
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: PhysicsUnit, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: PhysicsUnit, t: System.Type):UnityEngine.Component
---@overload fun(self: PhysicsUnit, includeInactive: System.Boolean):any
---@overload fun(self: PhysicsUnit):any
...
---函数名：GetComponents<p>
---函数名：GetComponents<p>
---@overload fun(self: PhysicsUnit, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: PhysicsUnit)
---@overload fun(self: PhysicsUnit)
---@overload fun(self: PhysicsUnit, type: System.Type):UnityEngine.Component[]
...
---@overload fun(self: PhysicsUnit)
---@overload fun(self: PhysicsUnit)
---@overload fun(self: PhysicsUnit, includeInactive: System.Boolean)
---@overload fun(self: PhysicsUnit, includeInactive: System.Boolean)
---@overload fun(self: PhysicsUnit, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
...
---介绍：只对单位类型为 [物理单位] 或者 [角色单位] 的单位生效<p>
---@overload fun(self: PhysicsUnit):System.Single
---@overload fun(self: PhysicsUnit):System.Single
...
---函数名：GetSkill<p>
---函数名：GetSkill<p>
---@overload fun(self: PhysicsUnit, id: System.String):Skill
---@overload fun(self: PhysicsUnit, ck: ControlKey):Skill
---@overload fun(self: PhysicsUnit, type: System.Type):Skill
...
---@overload fun(self: PhysicsUnit):UnityEngine.Vector2
---@overload fun(self: PhysicsUnit):UnityEngine.Vector2
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: PhysicsUnit, methodName: System.String):System.Boolean
---@overload fun(self: PhysicsUnit):System.Boolean
IsInvoking = function(...) end,

---函数名：RemoveSkill<p>
---函数名：RemoveSkill<p>
---@overload fun(self: PhysicsUnit, type: System.Type)
---@overload fun(self: PhysicsUnit, sk: Skill)
...
---函数名：SendMessage<p>
---@overload fun(self: PhysicsUnit, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: PhysicsUnit, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: PhysicsUnit, methodName: System.String)
---@overload fun(self: PhysicsUnit, methodName: System.String, value: System.Object)
...
---@overload fun(self: PhysicsUnit, scale: System.Single)
---@overload fun(self: PhysicsUnit, scale: System.Single)
...
---介绍：只对单位类型为 [物理单位] 或者 [角色单位] 的单位生效<p>
---@overload fun(self: PhysicsUnit, v: UnityEngine.Vector2)
---@overload fun(self: PhysicsUnit, v: UnityEngine.Vector2)
...
---介绍：只对单位类型为 [物理单位] 或者 [角色单位] 的单位生效<p>
---@overload fun(self: PhysicsUnit, v: System.Single)
---@overload fun(self: PhysicsUnit, v: System.Single)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: PhysicsUnit, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: PhysicsUnit, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
---@overload fun(self: PhysicsUnit, methodName: System.String, value: System.Object):UnityEngine.Coroutine
...
---函数名：StopCoroutine<p>
---@overload fun(self: PhysicsUnit, methodName: System.String)
---@overload fun(self: PhysicsUnit, routine: UnityEngine.Coroutine)
---@overload fun(self: PhysicsUnit, routine: System.Collections.IEnumerator)
StopCoroutine = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: PhysicsUnit):System.Boolean
---@overload fun(self: PhysicsUnit, type: System.Type, component: UnityEngine.Component&):System.Boolean
TryGetComponent = function(...) end,

---函数名：UpdatePos<p>
---函数名：UpdatePos<p>
---@overload fun(self: PhysicsUnit, pivot: UnityEngine.Vector2)
---@overload fun(self: PhysicsUnit, pivot: UnityEngine.Vector2, size: UnityEngine.Vector2)
UpdatePos = function(...) end,

---函数名：AddArchiveData<p>
---@param self PhysicsUnit
