...
---@overload fun(self: PhysicsUnit, f: UnityEngine.Vector2, fm?: UnityEngine.ForceMode2D)
---@overload fun(self: PhysicsUnit, f: UnityEngine.Vector2, fm?: UnityEngine.ForceMode2D)
...
---函数名：GetComponents<p>
---函数名：GetComponents<p>
---@overload fun(self: PhysicsUnit, type: System.Type, results: System.Collections.Generic.List)
---@overload fun(self: PhysicsUnit)
---@overload fun(self: PhysicsUnit)
---@overload fun(self: PhysicsUnit, type: System.Type):UnityEngine.Component[]
