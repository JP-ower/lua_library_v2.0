...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: SK_CollisionHide, methodName: System.String, parameter: System.Object)
---@overload fun(self: SK_CollisionHide, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_CollisionHide, methodName: System.String)
---@overload fun(self: SK_CollisionHide, methodName: System.String, options: UnityEngine.SendMessageOptions)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: SK_CollisionHide, methodName: System.String)
---@overload fun(self: SK_CollisionHide)
CancelInvoke = function(...) end,

---函数名：GetComponent<p>
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: SK_CollisionHide, type: System.Type):UnityEngine.Component
---@overload fun(self: SK_CollisionHide):any
---@overload fun(self: SK_CollisionHide, type: System.String):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: SK_CollisionHide, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: SK_CollisionHide, t: System.Type):UnityEngine.Component
---@overload fun(self: SK_CollisionHide, includeInactive: System.Boolean):any
---@overload fun(self: SK_CollisionHide):any
...
---@overload fun(self: SK_CollisionHide)
---@overload fun(self: SK_CollisionHide)
---@overload fun(self: SK_CollisionHide, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: SK_CollisionHide, type: System.Type):UnityEngine.Component[]
...
---@overload fun(self: SK_CollisionHide)
---@overload fun(self: SK_CollisionHide)
---@overload fun(self: SK_CollisionHide, includeInactive: System.Boolean)
---@overload fun(self: SK_CollisionHide, includeInactive: System.Boolean)
---@overload fun(self: SK_CollisionHide, t: System.Type):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: SK_CollisionHide):System.Boolean
---@overload fun(self: SK_CollisionHide, methodName: System.String):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: SK_CollisionHide, methodName: System.String)
---@overload fun(self: SK_CollisionHide, methodName: System.String, value: System.Object)
---@overload fun(self: SK_CollisionHide, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_CollisionHide, methodName: System.String, options: UnityEngine.SendMessageOptions)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: SK_CollisionHide, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
---@overload fun(self: SK_CollisionHide, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: SK_CollisionHide, methodName: System.String):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: SK_CollisionHide, routine: System.Collections.IEnumerator)
---@overload fun(self: SK_CollisionHide, routine: UnityEngine.Coroutine)
---@overload fun(self: SK_CollisionHide, methodName: System.String)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: SK_CollisionHide, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: SK_CollisionHide, unit: Unit):System.Boolean
TargetDetection = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: SK_CollisionHide, type: System.Type, component: UnityEngine.Component&):System.Boolean
---@overload fun(self: SK_CollisionHide):System.Boolean
TryGetComponent = function(...) end,

---函数名：AddControlKey<p>
---@param self SK_CollisionHide
---@param ck ControlKey
...
---函数名：OnFirstPlayerRevive<p>
---@param self SK_CollisionHide
OnFirstPlayerRevive = function(self) end,
...
---字段名：collisionDownRun<p>
---@type System.Boolean
collisionDownRun = nil,

---字段名：collisionLeftRun<p>
---@type System.Boolean
collisionLeftRun = nil,

---字段名：collisionRightRun<p>
---@type System.Boolean
collisionRightRun = nil,

---字段名：collisionUpRun<p>
---@type System.Boolean
collisionUpRun = nil,
...
---字段名：playerDeathReset<p>
---@type System.Boolean
playerDeathReset = nil,
