...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: SK_LaunchUnit, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_LaunchUnit, methodName: System.String)
---@overload fun(self: SK_LaunchUnit, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_LaunchUnit, methodName: System.String, parameter: System.Object)
BroadcastMessage = function(...) end,

---函数名：CancelInvoke<p>
---函数名：CancelInvoke<p>
---@overload fun(self: SK_LaunchUnit)
---@overload fun(self: SK_LaunchUnit, methodName: System.String)
...
---函数名：GetComponent<p>
---函数名：GetComponent<p>
---@overload fun(self: SK_LaunchUnit, type: System.Type):UnityEngine.Component
---@overload fun(self: SK_LaunchUnit):any
---@overload fun(self: SK_LaunchUnit, type: System.String):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: SK_LaunchUnit, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
---@overload fun(self: SK_LaunchUnit, t: System.Type):UnityEngine.Component
---@overload fun(self: SK_LaunchUnit, includeInactive: System.Boolean):any
---@overload fun(self: SK_LaunchUnit):any
...
----@return any
---@overload fun(self: SK_LaunchUnit)
---@overload fun(self: SK_LaunchUnit, type: System.Type, results: System.Collections.Generic.List`1[[UnityEngine.Component, UnityEngine.CoreModule, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null]])
---@overload fun(self: SK_LaunchUnit, type: System.Type):UnityEngine.Component[]
---@overload fun(self: SK_LaunchUnit)
...
---@overload fun(self: SK_LaunchUnit)
---@overload fun(self: SK_LaunchUnit)
---@overload fun(self: SK_LaunchUnit, includeInactive: System.Boolean)
---@overload fun(self: SK_LaunchUnit, includeInactive: System.Boolean)
---@overload fun(self: SK_LaunchUnit, t: System.Type):UnityEngine.Component[]
---@overload fun(self: SK_LaunchUnit, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
...
---函数名：IsInvoking<p>
---函数名：IsInvoking<p>
---@overload fun(self: SK_LaunchUnit, methodName: System.String):System.Boolean
---@overload fun(self: SK_LaunchUnit):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: SK_LaunchUnit, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_LaunchUnit, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: SK_LaunchUnit, methodName: System.String)
---@overload fun(self: SK_LaunchUnit, methodName: System.String, value: System.Object)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: SK_LaunchUnit, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: SK_LaunchUnit, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: SK_LaunchUnit, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: SK_LaunchUnit, routine: System.Collections.IEnumerator)
---@overload fun(self: SK_LaunchUnit, methodName: System.String)
---@overload fun(self: SK_LaunchUnit, routine: UnityEngine.Coroutine)
StopCoroutine = function(...) end,

---函数名：TargetDetection<p>
---函数名：TargetDetection<p>
---@overload fun(self: SK_LaunchUnit, unit: Unit, affectTargetType: System.String):System.Boolean
---@overload fun(self: SK_LaunchUnit, unit: Unit):System.Boolean
TargetDetection = function(...) end,

---函数名：TryGetComponent<p>
---函数名：TryGetComponent<p>
---@overload fun(self: SK_LaunchUnit, type: System.Type, component: UnityEngine.Component&):System.Boolean
---@overload fun(self: SK_LaunchUnit):System.Boolean
TryGetComponent = function(...) end,

---函数名：AddControlKey<p>
---@param self SK_LaunchUnit
---@param ck ControlKey
...
---字段名：launchInterval<p>
---@type System.Single
launchInterval = nil,

---字段名：launchPosOffset<p>
---@type UnityEngine.Vector2
launchPosOffset = nil,

---字段名：launchUseAniScale<p>
---@type System.Boolean
launchUseAniScale = nil,
...
---字段名：playerReviveDeleteUnit<p>
---@type System.Boolean
playerReviveDeleteUnit = nil,

---字段名：playerReviveReDelay<p>
---@type System.Boolean
playerReviveReDelay = nil,

---字段名：playerReviveReInterval<p>
---@type System.Boolean
playerReviveReInterval = nil,
