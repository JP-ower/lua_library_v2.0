...
---函数名：BroadcastMessage<p>
---函数名：BroadcastMessage<p>
---@overload fun(self: UI_JFY_CardSelectCard, methodName: System.String, parameter: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: UI_JFY_CardSelectCard, methodName: System.String, parameter: System.Object)
---@overload fun(self: UI_JFY_CardSelectCard, methodName: System.String)
---@overload fun(self: UI_JFY_CardSelectCard, methodName: System.String, options: UnityEngine.SendMessageOptions)
...
---@overload fun(self: UI_JFY_CardSelectCard):any
---@overload fun(self: UI_JFY_CardSelectCard, type: System.String):UnityEngine.Component
...
---函数名：GetComponentInChildren<p>
---函数名：GetComponentInChildren<p>
---@overload fun(self: UI_JFY_CardSelectCard, t: System.Type):UnityEngine.Component
---@overload fun(self: UI_JFY_CardSelectCard, includeInactive: System.Boolean):any
---@overload fun(self: UI_JFY_CardSelectCard):any
---@overload fun(self: UI_JFY_CardSelectCard, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component
...
---函数名：GetComponentsInChildren<p>
----@return any
---@overload fun(self: UI_JFY_CardSelectCard, includeInactive: System.Boolean)
---@overload fun(self: UI_JFY_CardSelectCard, includeInactive: System.Boolean)
---@overload fun(self: UI_JFY_CardSelectCard, t: System.Type):UnityEngine.Component[]
---@overload fun(self: UI_JFY_CardSelectCard, t: System.Type, includeInactive: System.Boolean):UnityEngine.Component[]
---@overload fun(self: UI_JFY_CardSelectCard)
...
---@overload fun(self: UI_JFY_CardSelectCard, methodName: System.String):System.Boolean
...
---函数名：SendMessage<p>
---@overload fun(self: UI_JFY_CardSelectCard, methodName: System.String, options: UnityEngine.SendMessageOptions)
---@overload fun(self: UI_JFY_CardSelectCard, methodName: System.String, value: System.Object, options: UnityEngine.SendMessageOptions)
---@overload fun(self: UI_JFY_CardSelectCard, methodName: System.String, value: System.Object)
---@overload fun(self: UI_JFY_CardSelectCard, methodName: System.String)
...
---函数名：StartCoroutine<p>
---函数名：StartCoroutine<p>
---@overload fun(self: UI_JFY_CardSelectCard, methodName: System.String):UnityEngine.Coroutine
---@overload fun(self: UI_JFY_CardSelectCard, methodName: System.String, value: System.Object):UnityEngine.Coroutine
---@overload fun(self: UI_JFY_CardSelectCard, routine: System.Collections.IEnumerator):UnityEngine.Coroutine
StartCoroutine = function(...) end,

---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---函数名：StopCoroutine<p>
---@overload fun(self: UI_JFY_CardSelectCard, routine: System.Collections.IEnumerator)
---@overload fun(self: UI_JFY_CardSelectCard, routine: UnityEngine.Coroutine)
---@overload fun(self: UI_JFY_CardSelectCard, methodName: System.String)
